...
parameter Real secd_pipe_v_nominal=1.501876215784073   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.3142037692361096 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=43075.100754883395    "the pressure drop when the valve is fully open (pa)";
