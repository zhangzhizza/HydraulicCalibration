...
parameter Real secd_pipe_v_nominal=1.3602034460363914   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.34956432263769055 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=5537.74769267105    "the pressure drop when the valve is fully open (pa)";
