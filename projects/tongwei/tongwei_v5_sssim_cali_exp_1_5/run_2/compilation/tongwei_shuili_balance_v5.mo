...
parameter Real secd_pipe_v_nominal=0.5243806086356566   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.030371819498131 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=27256.422260910273    "the pressure drop when the valve is fully open (pa)";
