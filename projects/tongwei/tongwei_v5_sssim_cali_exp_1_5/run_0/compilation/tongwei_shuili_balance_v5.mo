...
parameter Real secd_pipe_v_nominal=3.5589126859587976   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.3177938462742634 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=17202.951124062176    "the pressure drop when the valve is fully open (pa)";
