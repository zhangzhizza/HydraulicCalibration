...
parameter Real secd_pipe_v_nominal=3.449992227528298   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.6678306626667796 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=45146.68098591826    "the pressure drop when the valve is fully open (pa)";
