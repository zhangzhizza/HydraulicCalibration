...
parameter Real secd_pipe_v_nominal=2.163912068857573   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.3933637909654153 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=31423.70827186515    "the pressure drop when the valve is fully open (pa)";
