...
parameter Real secd_pipe_v_nominal=1.9261968231149262   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.8901019178078364 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=14425.284815893046    "the pressure drop when the valve is fully open (pa)";
