...
parameter Real secd_pipe_v_nominal=2.315920290378703   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.3437858277441691 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=18454.79994432861    "the pressure drop when the valve is fully open (pa)";
