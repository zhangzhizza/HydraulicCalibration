...
parameter Real secd_pipe_v_nominal=0.22849357118032967   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.438359977171623 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=7238.576502460166    "the pressure drop when the valve is fully open (pa)";
