...
parameter Real secd_pipe_v_nominal=1.715729172904326   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.0356844901764033 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49694.8107178481    "the pressure drop when the valve is fully open (pa)";
