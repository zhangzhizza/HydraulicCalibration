...
parameter Real secd_pipe_v_nominal=1.0662627381578593   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.3376038601963582 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=44586.098036320276    "the pressure drop when the valve is fully open (pa)";
