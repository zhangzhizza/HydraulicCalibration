...
parameter Real secd_pipe_v_nominal=1.7368571319991524   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.733741885531521 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=8552.296707542995    "the pressure drop when the valve is fully open (pa)";
