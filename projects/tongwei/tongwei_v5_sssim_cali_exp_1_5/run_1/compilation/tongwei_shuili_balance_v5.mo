...
parameter Real secd_pipe_v_nominal=2.0588850620199515   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1254911668830379 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=18313.01127356834    "the pressure drop when the valve is fully open (pa)";
