...
parameter Real secd_pipe_v_nominal=2.272394049903868   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.7874207812824896 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=26897.38292858356    "the pressure drop when the valve is fully open (pa)";
