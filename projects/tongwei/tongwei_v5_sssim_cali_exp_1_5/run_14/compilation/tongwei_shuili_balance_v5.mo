...
parameter Real secd_pipe_v_nominal=2.262295588116294   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.013531055412184 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=25843.375173500473    "the pressure drop when the valve is fully open (pa)";
