...
parameter Real secd_pipe_v_nominal=0.380239905697489   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.7677105433523197 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=13617.850607480674    "the pressure drop when the valve is fully open (pa)";
