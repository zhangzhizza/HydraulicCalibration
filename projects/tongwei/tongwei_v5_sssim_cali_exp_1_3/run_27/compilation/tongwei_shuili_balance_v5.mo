...
parameter Real secd_pipe_v_nominal=1.483902520040894   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.546283444483876 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=128715.72576151165    "the pressure drop when the valve is fully open (pa)";
