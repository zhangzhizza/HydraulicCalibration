...
parameter Real secd_pipe_v_nominal=0.9019726351834327   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8608197396507562 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=204638.76220500615    "the pressure drop when the valve is fully open (pa)";
