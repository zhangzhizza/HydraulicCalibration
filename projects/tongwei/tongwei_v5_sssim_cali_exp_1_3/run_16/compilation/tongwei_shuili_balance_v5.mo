...
parameter Real secd_pipe_v_nominal=1.000420080987361   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.9654713164909006 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=473774.49933452776    "the pressure drop when the valve is fully open (pa)";
