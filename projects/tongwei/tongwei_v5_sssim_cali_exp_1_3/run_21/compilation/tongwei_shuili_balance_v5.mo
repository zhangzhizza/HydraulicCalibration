...
parameter Real secd_pipe_v_nominal=3.8388808754980417   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.3680220500988332 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=296561.54523898166    "the pressure drop when the valve is fully open (pa)";
