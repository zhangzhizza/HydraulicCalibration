...
parameter Real secd_pipe_v_nominal=2.7138292334507597   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.2369123071762073 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=334534.3880422533    "the pressure drop when the valve is fully open (pa)";
