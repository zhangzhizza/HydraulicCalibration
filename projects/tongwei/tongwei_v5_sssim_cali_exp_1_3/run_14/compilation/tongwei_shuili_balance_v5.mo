...
parameter Real secd_pipe_v_nominal=2.179179397188471   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.32556136345689957 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=322290.0149834283    "the pressure drop when the valve is fully open (pa)";
