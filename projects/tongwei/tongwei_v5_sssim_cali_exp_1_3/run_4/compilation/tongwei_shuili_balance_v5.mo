...
parameter Real secd_pipe_v_nominal=2.0739189550995536   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.264318989616263 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=292952.9081793882    "the pressure drop when the valve is fully open (pa)";
