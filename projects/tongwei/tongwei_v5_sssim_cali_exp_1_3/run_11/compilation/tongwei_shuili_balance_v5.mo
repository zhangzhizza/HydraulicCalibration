...
parameter Real secd_pipe_v_nominal=1.1019165175349872   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.9139350432377644 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=440869.68072371825    "the pressure drop when the valve is fully open (pa)";
