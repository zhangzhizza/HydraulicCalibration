...
parameter Real secd_pipe_v_nominal=2.1129420934208216   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.5793988718979635 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=375159.28380940086    "the pressure drop when the valve is fully open (pa)";
