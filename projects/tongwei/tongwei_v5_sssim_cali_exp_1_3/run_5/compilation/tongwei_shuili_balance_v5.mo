...
parameter Real secd_pipe_v_nominal=3.358770035023225   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1950906869196487 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=725.5064242541746    "the pressure drop when the valve is fully open (pa)";
