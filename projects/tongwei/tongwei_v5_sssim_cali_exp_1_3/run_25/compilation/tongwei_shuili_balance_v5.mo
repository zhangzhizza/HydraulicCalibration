...
parameter Real secd_pipe_v_nominal=3.8854947164932305   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.9138923985728695 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=410752.1642734112    "the pressure drop when the valve is fully open (pa)";
