...
parameter Real secd_pipe_v_nominal=3.087052033504919   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4672193378603338 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=185011.7878533031    "the pressure drop when the valve is fully open (pa)";
