...
parameter Real secd_pipe_v_nominal=3.0791637398152463   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.21777179455835505 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=52809.38618119134    "the pressure drop when the valve is fully open (pa)";
