...
parameter Real secd_pipe_v_nominal=2.0584793996975654   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1275923876734892 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=32952.332284788325    "the pressure drop when the valve is fully open (pa)";
