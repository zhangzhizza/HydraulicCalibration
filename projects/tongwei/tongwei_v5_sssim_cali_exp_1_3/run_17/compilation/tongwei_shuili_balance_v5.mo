...
parameter Real secd_pipe_v_nominal=3.618875830201821   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.2192469190768507 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=151049.484946316    "the pressure drop when the valve is fully open (pa)";
