...
parameter Real secd_pipe_v_nominal=1.2382359266894352   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.694069370800388 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=22178.899754109563    "the pressure drop when the valve is fully open (pa)";
