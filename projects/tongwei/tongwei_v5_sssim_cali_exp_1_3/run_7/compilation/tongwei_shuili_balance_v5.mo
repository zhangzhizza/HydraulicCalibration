...
parameter Real secd_pipe_v_nominal=1.2180642103455979   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.8119814518585375 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=105571.0345739771    "the pressure drop when the valve is fully open (pa)";
