...
parameter Real secd_pipe_v_nominal=1.1156672214586054   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.705847059341135 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=344849.7484478873    "the pressure drop when the valve is fully open (pa)";
