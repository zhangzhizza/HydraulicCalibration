...
parameter Real secd_pipe_v_nominal=1.1236464148348726   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8977607826780312 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=198574.65678644954    "the pressure drop when the valve is fully open (pa)";
