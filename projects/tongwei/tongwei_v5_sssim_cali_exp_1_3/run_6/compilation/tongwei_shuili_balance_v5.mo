...
parameter Real secd_pipe_v_nominal=3.100860968469778   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.077249504700038 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=165228.77510943095    "the pressure drop when the valve is fully open (pa)";
