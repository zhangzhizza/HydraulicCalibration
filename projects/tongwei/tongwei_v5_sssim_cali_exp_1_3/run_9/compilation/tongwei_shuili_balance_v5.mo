...
parameter Real secd_pipe_v_nominal=1.2489565034508823   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.133860716833651 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=309518.3606729163    "the pressure drop when the valve is fully open (pa)";
