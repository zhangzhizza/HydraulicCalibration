...
parameter Real secd_pipe_v_nominal=1.861267352026728   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.31593619931051475 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=222643.14707445953    "the pressure drop when the valve is fully open (pa)";
