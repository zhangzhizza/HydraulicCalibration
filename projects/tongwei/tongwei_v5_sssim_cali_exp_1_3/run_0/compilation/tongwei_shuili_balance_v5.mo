...
parameter Real secd_pipe_v_nominal=0.7487692638030936   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4891999902956439 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=324531.63345043437    "the pressure drop when the valve is fully open (pa)";
