...
parameter Real secd_pipe_v_nominal=3.606905321778052   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.6333921567063805 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=258356.01025103268    "the pressure drop when the valve is fully open (pa)";
