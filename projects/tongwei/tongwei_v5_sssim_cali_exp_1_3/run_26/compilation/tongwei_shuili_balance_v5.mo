...
parameter Real secd_pipe_v_nominal=3.4975970233481717   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0701157758548747 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=350379.51281159994    "the pressure drop when the valve is fully open (pa)";
