...
parameter Real secd_pipe_v_nominal=2.846817148545707   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.8415626502918772 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=312448.19299778464    "the pressure drop when the valve is fully open (pa)";
