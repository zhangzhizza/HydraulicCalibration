...
parameter Real secd_pipe_v_nominal=1.7708717736223332   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.899382204615519 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=158612.66906199764    "the pressure drop when the valve is fully open (pa)";
