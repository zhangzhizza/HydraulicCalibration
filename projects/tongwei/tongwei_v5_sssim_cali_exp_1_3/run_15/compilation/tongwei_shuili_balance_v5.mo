...
parameter Real secd_pipe_v_nominal=2.182090778101658   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.88782553218062 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=232427.95626810272    "the pressure drop when the valve is fully open (pa)";
