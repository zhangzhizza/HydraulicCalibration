...
model tongwei_shuili_balance_v5
 ...
 Buildings.Fluid.FixedResistances.PressureDrop bypass_pipe(
  ...
  parameter Real secd_pipe_v_nominal=0.5   "the water velocity of second pump(m/s)";
  ...
  parameter Real prim_pipe_v_nominal=3 "the velocity of chiller water(m/s";
  ...
  parameter Real terminal_dpopen=20000
    "the pressure drop when the valve is fully open (pa)";
