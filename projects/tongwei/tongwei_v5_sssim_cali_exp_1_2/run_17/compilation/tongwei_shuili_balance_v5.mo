...
parameter Real secd_pipe_v_nominal=1.8989761885545324   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.6019566166903858 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=444854.2294505995    "the pressure drop when the valve is fully open (pa)";
