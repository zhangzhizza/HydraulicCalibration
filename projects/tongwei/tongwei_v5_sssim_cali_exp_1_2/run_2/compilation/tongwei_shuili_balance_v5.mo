...
parameter Real secd_pipe_v_nominal=1.3851237142156831   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.4997624638354243 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=280552.05736181815    "the pressure drop when the valve is fully open (pa)";
