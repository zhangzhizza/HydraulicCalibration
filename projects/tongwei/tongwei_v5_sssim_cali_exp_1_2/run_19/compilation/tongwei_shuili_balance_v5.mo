...
parameter Real secd_pipe_v_nominal=3.225920007761712   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.8246112827621463 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=450740.5098208565    "the pressure drop when the valve is fully open (pa)";
