...
parameter Real secd_pipe_v_nominal=0.8230224809559661   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.8937913902567691 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=470456.1046129683    "the pressure drop when the valve is fully open (pa)";
