...
parameter Real secd_pipe_v_nominal=0.3464290504098275   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.2115877949782274 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=424536.41482270946    "the pressure drop when the valve is fully open (pa)";
