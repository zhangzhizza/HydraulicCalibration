...
parameter Real secd_pipe_v_nominal=1.7984434245434135   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.5209895505964535 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=2401.7119716927473    "the pressure drop when the valve is fully open (pa)";
