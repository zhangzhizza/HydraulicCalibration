...
parameter Real secd_pipe_v_nominal=1.895610204175713   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.994792119077249 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=441046.9813137154    "the pressure drop when the valve is fully open (pa)";
