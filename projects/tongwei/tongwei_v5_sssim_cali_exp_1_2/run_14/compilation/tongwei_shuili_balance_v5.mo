...
parameter Real secd_pipe_v_nominal=1.567511961836692   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.385686322081946 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=491725.58127147064    "the pressure drop when the valve is fully open (pa)";
