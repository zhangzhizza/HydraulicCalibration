...
parameter Real secd_pipe_v_nominal=1.0297751147759548   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.590268801489512 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=102160.55757863315    "the pressure drop when the valve is fully open (pa)";
