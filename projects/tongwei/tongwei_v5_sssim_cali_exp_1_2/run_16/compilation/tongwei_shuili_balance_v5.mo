...
parameter Real secd_pipe_v_nominal=2.0532806095375635   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.49886956838324276 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=302479.63496663736    "the pressure drop when the valve is fully open (pa)";
