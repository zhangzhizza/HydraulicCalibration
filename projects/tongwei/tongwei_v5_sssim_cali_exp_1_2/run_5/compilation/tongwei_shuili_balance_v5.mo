...
parameter Real secd_pipe_v_nominal=1.6930742096506222   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.0273830858058925 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=172820.05732716245    "the pressure drop when the valve is fully open (pa)";
