...
parameter Real secd_pipe_v_nominal=0.8402857306718363   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.21085074266832066 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=274447.73573839234    "the pressure drop when the valve is fully open (pa)";
