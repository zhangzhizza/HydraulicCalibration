...
parameter Real secd_pipe_v_nominal=1.3582255650511368   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.5774195648333427 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=185547.86262732086    "the pressure drop when the valve is fully open (pa)";
