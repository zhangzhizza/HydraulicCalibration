...
parameter Real secd_pipe_v_nominal=2.661204547895726   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.7043115129593724 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=171476.46216542745    "the pressure drop when the valve is fully open (pa)";
