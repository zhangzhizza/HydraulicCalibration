...
parameter Real secd_pipe_v_nominal=3.8377076904987106   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.523144755376094 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=386396.7303784487    "the pressure drop when the valve is fully open (pa)";
