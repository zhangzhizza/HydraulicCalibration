...
parameter Real secd_pipe_v_nominal=3.4089435882746906   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.82085753665211 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=360085.2737124023    "the pressure drop when the valve is fully open (pa)";
