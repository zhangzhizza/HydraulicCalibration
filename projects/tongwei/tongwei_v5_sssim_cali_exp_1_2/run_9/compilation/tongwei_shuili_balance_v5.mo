...
parameter Real secd_pipe_v_nominal=1.960828414462025   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0930464927095715 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=233645.392219553    "the pressure drop when the valve is fully open (pa)";
