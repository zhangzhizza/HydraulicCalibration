...
parameter Real secd_pipe_v_nominal=1.1756700344686613   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.241643570147062 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=174023.2230068255    "the pressure drop when the valve is fully open (pa)";
