...
parameter Real secd_pipe_v_nominal=2.584993395406198   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.5738910389869951 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=99788.41193675688    "the pressure drop when the valve is fully open (pa)";
