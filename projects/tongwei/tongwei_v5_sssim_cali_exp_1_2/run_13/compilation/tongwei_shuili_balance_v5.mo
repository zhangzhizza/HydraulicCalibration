...
parameter Real secd_pipe_v_nominal=3.861446317864819   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.049225556055442 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=92769.37404878007    "the pressure drop when the valve is fully open (pa)";
