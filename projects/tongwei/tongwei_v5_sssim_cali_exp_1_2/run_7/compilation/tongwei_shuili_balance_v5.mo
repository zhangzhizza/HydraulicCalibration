...
parameter Real secd_pipe_v_nominal=0.5134892360280485   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.221119166403305 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=238449.02440821714    "the pressure drop when the valve is fully open (pa)";
