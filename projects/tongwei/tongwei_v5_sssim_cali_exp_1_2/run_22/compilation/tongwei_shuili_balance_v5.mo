...
parameter Real secd_pipe_v_nominal=2.222060495826143   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.711238376660541 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=243428.01625855092    "the pressure drop when the valve is fully open (pa)";
