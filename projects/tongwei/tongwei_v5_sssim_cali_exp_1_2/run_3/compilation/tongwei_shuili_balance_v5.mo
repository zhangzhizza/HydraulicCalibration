...
parameter Real secd_pipe_v_nominal=2.0873479004831066   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.3829325001377364 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=483930.34551365586    "the pressure drop when the valve is fully open (pa)";
