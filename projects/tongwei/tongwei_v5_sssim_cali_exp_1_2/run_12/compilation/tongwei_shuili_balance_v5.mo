...
parameter Real secd_pipe_v_nominal=3.664493136548281   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.9948802780207753 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=287358.3717139326    "the pressure drop when the valve is fully open (pa)";
