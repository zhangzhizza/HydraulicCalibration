...
parameter Real secd_pipe_v_nominal=3.4097411387323966   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.8511690077804333 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=427045.76760617463    "the pressure drop when the valve is fully open (pa)";
