...
parameter Real secd_pipe_v_nominal=3.235412353992843   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.2841356639747374 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=357930.0810929414    "the pressure drop when the valve is fully open (pa)";
