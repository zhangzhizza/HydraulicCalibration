...
parameter Real secd_pipe_v_nominal=2.783226334902332   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.282365253470268 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=258542.0672608307    "the pressure drop when the valve is fully open (pa)";
