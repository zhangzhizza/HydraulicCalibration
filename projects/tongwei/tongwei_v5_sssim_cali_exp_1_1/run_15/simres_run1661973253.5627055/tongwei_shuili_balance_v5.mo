...
parameter Real secd_pipe_v_nominal=1.7494615581672492   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.737092333619208 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=166235.8645404356    "the pressure drop when the valve is fully open (pa)";
