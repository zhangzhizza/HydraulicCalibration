...
parameter Real secd_pipe_v_nominal=0.42336617208411487   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.8633000045829862 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=363085.93157703395    "the pressure drop when the valve is fully open (pa)";
