...
parameter Real secd_pipe_v_nominal=2.6013387263955514   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.434975341619959 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=442578.120318751    "the pressure drop when the valve is fully open (pa)";
