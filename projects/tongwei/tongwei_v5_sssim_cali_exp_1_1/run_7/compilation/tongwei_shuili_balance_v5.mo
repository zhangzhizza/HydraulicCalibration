...
parameter Real secd_pipe_v_nominal=3.6118884385933367   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0189950728293802 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=369016.3986329002    "the pressure drop when the valve is fully open (pa)";
