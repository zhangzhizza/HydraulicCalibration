...
parameter Real secd_pipe_v_nominal=2.04580716989198   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.9617686460804293 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=282237.91646809014    "the pressure drop when the valve is fully open (pa)";
