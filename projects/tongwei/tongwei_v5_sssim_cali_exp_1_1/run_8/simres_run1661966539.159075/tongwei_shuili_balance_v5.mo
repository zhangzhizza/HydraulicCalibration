...
parameter Real secd_pipe_v_nominal=2.7328823142263987   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.2624873736306985 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=338275.99826077913    "the pressure drop when the valve is fully open (pa)";
