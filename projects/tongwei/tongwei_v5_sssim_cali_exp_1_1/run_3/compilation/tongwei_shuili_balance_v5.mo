...
parameter Real secd_pipe_v_nominal=3.827414300302099   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.476098812923059 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=325754.4345570763    "the pressure drop when the valve is fully open (pa)";
