...
parameter Real secd_pipe_v_nominal=2.224242980391089   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.2273709648836366 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=411646.6980312691    "the pressure drop when the valve is fully open (pa)";
