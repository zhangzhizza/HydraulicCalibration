...
parameter Real secd_pipe_v_nominal=1.06593650431709   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.355095741823778 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=487492.07908207935    "the pressure drop when the valve is fully open (pa)";
