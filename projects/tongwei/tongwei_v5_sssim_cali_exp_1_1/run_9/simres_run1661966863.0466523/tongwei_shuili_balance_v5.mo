...
parameter Real secd_pipe_v_nominal=3.791288718342188   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.3796671640583992 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=459493.135158343    "the pressure drop when the valve is fully open (pa)";
