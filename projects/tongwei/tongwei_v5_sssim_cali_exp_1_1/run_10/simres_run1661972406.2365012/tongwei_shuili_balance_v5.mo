...
parameter Real secd_pipe_v_nominal=2.6812406452851567   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.448901392684044 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=17290.936579115016    "the pressure drop when the valve is fully open (pa)";
