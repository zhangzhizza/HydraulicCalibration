...
parameter Real secd_pipe_v_nominal=3.403911626487684   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.374401159445509 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=144485.02595111277    "the pressure drop when the valve is fully open (pa)";
