...
parameter Real secd_pipe_v_nominal=1.210616393977381   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.9386092909868324 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=59688.868017423236    "the pressure drop when the valve is fully open (pa)";
