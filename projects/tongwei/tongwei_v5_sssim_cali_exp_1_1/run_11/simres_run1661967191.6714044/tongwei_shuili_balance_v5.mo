...
parameter Real secd_pipe_v_nominal=2.52082245222571   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.82455310145694 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=488718.0335485764    "the pressure drop when the valve is fully open (pa)";
