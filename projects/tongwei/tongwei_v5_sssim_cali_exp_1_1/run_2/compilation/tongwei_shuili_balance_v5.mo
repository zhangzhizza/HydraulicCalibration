...
parameter Real secd_pipe_v_nominal=0.8348100189542482   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.343849984185698 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=137400.01570755758    "the pressure drop when the valve is fully open (pa)";
