...
parameter Real secd_pipe_v_nominal=2.271863878375734   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.9398682034510186 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=161337.9822593787    "the pressure drop when the valve is fully open (pa)";
