...
parameter Real secd_pipe_v_nominal=1.3996835132666836   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1719833780068756 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=95780.19987518444    "the pressure drop when the valve is fully open (pa)";
