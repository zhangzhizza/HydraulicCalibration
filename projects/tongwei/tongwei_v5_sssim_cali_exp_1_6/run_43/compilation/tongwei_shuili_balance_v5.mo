...
parameter Real secd_pipe_v_nominal=0.41666070377784925   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4728152527464016 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49117.85893604538    "the pressure drop when the valve is fully open (pa)";
