...
parameter Real secd_pipe_v_nominal=1.7035883780965282   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.6167601968768512 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49942.80607850897    "the pressure drop when the valve is fully open (pa)";
