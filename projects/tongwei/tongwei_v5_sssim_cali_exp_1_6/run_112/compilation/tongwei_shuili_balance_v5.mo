...
parameter Real secd_pipe_v_nominal=0.882133839778025   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.61435037596056 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49407.31654639721    "the pressure drop when the valve is fully open (pa)";
