...
parameter Real secd_pipe_v_nominal=2.51187533772336   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.594523368698783 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49348.575796405006    "the pressure drop when the valve is fully open (pa)";
