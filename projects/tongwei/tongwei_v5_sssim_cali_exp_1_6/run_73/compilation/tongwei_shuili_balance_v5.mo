...
parameter Real secd_pipe_v_nominal=2.91627035712964   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1540040152940474 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49136.10910956763    "the pressure drop when the valve is fully open (pa)";
