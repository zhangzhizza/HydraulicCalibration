...
parameter Real secd_pipe_v_nominal=2.443064287382548   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.105079054321936 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49286.695741948424    "the pressure drop when the valve is fully open (pa)";
