...
parameter Real secd_pipe_v_nominal=0.6477905181330067   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0839366896483442 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49155.51452708925    "the pressure drop when the valve is fully open (pa)";
