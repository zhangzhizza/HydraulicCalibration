...
parameter Real secd_pipe_v_nominal=3.6063926481149613   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.9215397659854043 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49698.42244235783    "the pressure drop when the valve is fully open (pa)";
