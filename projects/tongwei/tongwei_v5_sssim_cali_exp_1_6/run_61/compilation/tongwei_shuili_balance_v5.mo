...
parameter Real secd_pipe_v_nominal=2.9731392632500957   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.4375062294404245 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49619.115497462015    "the pressure drop when the valve is fully open (pa)";
