...
parameter Real secd_pipe_v_nominal=0.22166820880311167   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.4680936428819553 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49431.01718238436    "the pressure drop when the valve is fully open (pa)";
