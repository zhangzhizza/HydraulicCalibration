...
parameter Real secd_pipe_v_nominal=3.6063979664006434   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.6122207492083254 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49488.12751637276    "the pressure drop when the valve is fully open (pa)";
