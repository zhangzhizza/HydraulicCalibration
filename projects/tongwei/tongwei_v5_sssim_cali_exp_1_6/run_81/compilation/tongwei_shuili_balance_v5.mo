...
parameter Real secd_pipe_v_nominal=0.4365257553207894   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.9598477429143353 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49922.84577491362    "the pressure drop when the valve is fully open (pa)";
