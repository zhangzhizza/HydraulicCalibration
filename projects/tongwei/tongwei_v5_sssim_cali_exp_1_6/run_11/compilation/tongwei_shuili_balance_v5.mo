...
parameter Real secd_pipe_v_nominal=3.725927302035709   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.7316885973158214 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49572.91999158923    "the pressure drop when the valve is fully open (pa)";
