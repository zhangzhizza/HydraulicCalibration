...
parameter Real secd_pipe_v_nominal=2.692752342966882   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.8074673166372417 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49853.12965844122    "the pressure drop when the valve is fully open (pa)";
