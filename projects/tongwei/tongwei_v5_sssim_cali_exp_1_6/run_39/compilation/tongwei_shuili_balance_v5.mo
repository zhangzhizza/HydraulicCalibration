...
parameter Real secd_pipe_v_nominal=3.793365028936299   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.5470481048336193 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49196.856262400506    "the pressure drop when the valve is fully open (pa)";
