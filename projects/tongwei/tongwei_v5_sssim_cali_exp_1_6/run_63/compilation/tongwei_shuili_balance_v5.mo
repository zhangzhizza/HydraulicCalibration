...
parameter Real secd_pipe_v_nominal=3.82237697653473   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.382214459173677 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49567.83783843622    "the pressure drop when the valve is fully open (pa)";
