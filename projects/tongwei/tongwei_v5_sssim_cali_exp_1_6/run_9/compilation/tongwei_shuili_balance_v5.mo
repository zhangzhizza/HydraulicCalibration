...
parameter Real secd_pipe_v_nominal=0.31148334202253436   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4619918345793042 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49114.333604535284    "the pressure drop when the valve is fully open (pa)";
