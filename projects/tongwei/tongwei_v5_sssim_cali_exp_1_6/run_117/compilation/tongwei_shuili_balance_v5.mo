...
parameter Real secd_pipe_v_nominal=3.047944058306191   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7441636509581833 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49535.12320133051    "the pressure drop when the valve is fully open (pa)";
