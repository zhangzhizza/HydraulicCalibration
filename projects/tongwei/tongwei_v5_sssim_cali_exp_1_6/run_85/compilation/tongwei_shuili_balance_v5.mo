...
parameter Real secd_pipe_v_nominal=2.364811133573395   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1143707176528013 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49496.51782054677    "the pressure drop when the valve is fully open (pa)";
