...
parameter Real secd_pipe_v_nominal=0.4755353153808239   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.5598448481598892 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49170.00935618291    "the pressure drop when the valve is fully open (pa)";
