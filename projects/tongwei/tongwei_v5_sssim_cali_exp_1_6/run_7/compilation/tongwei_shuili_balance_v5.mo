...
parameter Real secd_pipe_v_nominal=3.064777443706602   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.772470579844639 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49109.362395190954    "the pressure drop when the valve is fully open (pa)";
