...
parameter Real secd_pipe_v_nominal=2.005405766718688   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.662365767835221 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49510.38930735917    "the pressure drop when the valve is fully open (pa)";
