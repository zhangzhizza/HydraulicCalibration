...
parameter Real secd_pipe_v_nominal=2.502481286955692   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.902392304714342 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49202.33816022946    "the pressure drop when the valve is fully open (pa)";
