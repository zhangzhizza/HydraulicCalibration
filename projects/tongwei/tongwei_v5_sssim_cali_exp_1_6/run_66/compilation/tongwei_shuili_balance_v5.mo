...
parameter Real secd_pipe_v_nominal=1.3741132888717207   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.0737351938055397 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49602.44609772443    "the pressure drop when the valve is fully open (pa)";
