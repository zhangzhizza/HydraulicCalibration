...
parameter Real secd_pipe_v_nominal=2.5105157363509845   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.895488521691139 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49964.77364194028    "the pressure drop when the valve is fully open (pa)";
