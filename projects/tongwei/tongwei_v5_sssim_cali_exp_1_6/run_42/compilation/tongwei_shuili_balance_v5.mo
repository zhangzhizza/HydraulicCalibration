...
parameter Real secd_pipe_v_nominal=2.058277215121538   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4674167828956073 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49723.30730592689    "the pressure drop when the valve is fully open (pa)";
