...
parameter Real secd_pipe_v_nominal=1.4683935415981115   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1141920471796223 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49939.384097404865    "the pressure drop when the valve is fully open (pa)";
