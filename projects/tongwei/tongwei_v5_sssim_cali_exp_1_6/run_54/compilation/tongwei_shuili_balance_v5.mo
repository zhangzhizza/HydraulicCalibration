...
parameter Real secd_pipe_v_nominal=2.8794147031751183   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.8636987950611212 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49589.999384456896    "the pressure drop when the valve is fully open (pa)";
