...
parameter Real secd_pipe_v_nominal=2.208483513340326   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.5145957738103695 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49129.03253178648    "the pressure drop when the valve is fully open (pa)";
