...
parameter Real secd_pipe_v_nominal=3.9306835627327326   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1361869111183602 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49748.0820446251    "the pressure drop when the valve is fully open (pa)";
