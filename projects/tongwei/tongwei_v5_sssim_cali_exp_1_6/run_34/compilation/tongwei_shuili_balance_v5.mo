...
parameter Real secd_pipe_v_nominal=1.1192392056306049   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.5716238510584277 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49972.51916137508    "the pressure drop when the valve is fully open (pa)";
