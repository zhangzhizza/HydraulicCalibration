...
parameter Real secd_pipe_v_nominal=2.5408186576855085   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.6749579915776338 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49630.74108637391    "the pressure drop when the valve is fully open (pa)";
