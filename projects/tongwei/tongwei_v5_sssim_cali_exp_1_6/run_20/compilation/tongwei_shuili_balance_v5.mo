...
parameter Real secd_pipe_v_nominal=3.4597147931355585   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.936290520924965 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49851.597675163976    "the pressure drop when the valve is fully open (pa)";
