...
parameter Real secd_pipe_v_nominal=1.610711529560504   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.4358947912841056 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49677.60729405324    "the pressure drop when the valve is fully open (pa)";
