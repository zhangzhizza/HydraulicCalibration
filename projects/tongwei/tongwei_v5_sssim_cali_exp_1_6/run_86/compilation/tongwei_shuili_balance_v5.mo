...
parameter Real secd_pipe_v_nominal=0.6042795204255376   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.3515577280371232 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49316.24802999181    "the pressure drop when the valve is fully open (pa)";
