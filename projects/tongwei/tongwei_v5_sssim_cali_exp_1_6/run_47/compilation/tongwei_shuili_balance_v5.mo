...
parameter Real secd_pipe_v_nominal=2.0206364958668352   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.5794720241020417 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49944.1367801789    "the pressure drop when the valve is fully open (pa)";
