...
parameter Real secd_pipe_v_nominal=2.027743600203617   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.3762390333063803 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49105.90448936652    "the pressure drop when the valve is fully open (pa)";
