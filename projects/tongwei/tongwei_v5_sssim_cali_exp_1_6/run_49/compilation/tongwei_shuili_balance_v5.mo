...
parameter Real secd_pipe_v_nominal=0.32489408668547826   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.664672068764534 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49749.973812782286    "the pressure drop when the valve is fully open (pa)";
