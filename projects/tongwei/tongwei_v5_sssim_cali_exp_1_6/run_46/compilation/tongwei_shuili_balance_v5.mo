...
parameter Real secd_pipe_v_nominal=0.8961749561576065   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.7056167222874581 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49424.79674659566    "the pressure drop when the valve is fully open (pa)";
