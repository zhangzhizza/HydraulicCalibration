...
parameter Real secd_pipe_v_nominal=0.24671415590638437   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.0617353605536795 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49991.97125863816    "the pressure drop when the valve is fully open (pa)";
