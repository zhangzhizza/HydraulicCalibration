...
parameter Real secd_pipe_v_nominal=3.734424739114393   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.2125080362323217 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49203.75317765584    "the pressure drop when the valve is fully open (pa)";
