...
parameter Real secd_pipe_v_nominal=1.9930174631811812   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1780589794214977 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49206.63834045242    "the pressure drop when the valve is fully open (pa)";
