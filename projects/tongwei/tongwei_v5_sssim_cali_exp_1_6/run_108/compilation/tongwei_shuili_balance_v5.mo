...
parameter Real secd_pipe_v_nominal=3.597275981598263   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8328227031185671 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49091.30718192537    "the pressure drop when the valve is fully open (pa)";
