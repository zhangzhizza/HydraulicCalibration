...
parameter Real secd_pipe_v_nominal=2.171595229426411   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.2861897140377772 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49913.257444556184    "the pressure drop when the valve is fully open (pa)";
