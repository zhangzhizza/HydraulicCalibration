...
parameter Real secd_pipe_v_nominal=2.7735510001453676   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7104500196372556 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49636.04845423579    "the pressure drop when the valve is fully open (pa)";
