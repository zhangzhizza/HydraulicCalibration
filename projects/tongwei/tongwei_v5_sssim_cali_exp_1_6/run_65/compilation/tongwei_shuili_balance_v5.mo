...
parameter Real secd_pipe_v_nominal=3.0748007353792297   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1033267819017551 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49515.40743441573    "the pressure drop when the valve is fully open (pa)";
