...
parameter Real secd_pipe_v_nominal=1.6440746478201367   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.666770709902964 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49297.54715467473    "the pressure drop when the valve is fully open (pa)";
