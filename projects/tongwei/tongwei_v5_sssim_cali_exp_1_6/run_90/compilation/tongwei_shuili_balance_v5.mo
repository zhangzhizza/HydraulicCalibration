...
parameter Real secd_pipe_v_nominal=3.6819063644625953   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.806437306538701 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49151.67525901772    "the pressure drop when the valve is fully open (pa)";
