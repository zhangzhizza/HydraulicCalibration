...
parameter Real secd_pipe_v_nominal=1.5341173535665196   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.0156683228319983 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49304.11084612777    "the pressure drop when the valve is fully open (pa)";
