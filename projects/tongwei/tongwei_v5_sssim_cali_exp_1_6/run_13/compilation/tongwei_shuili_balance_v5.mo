...
parameter Real secd_pipe_v_nominal=0.49230718359124886   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.657021669247826 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49446.0067489857    "the pressure drop when the valve is fully open (pa)";
