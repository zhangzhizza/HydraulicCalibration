...
parameter Real secd_pipe_v_nominal=1.043022261317802   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.968886109496969 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49416.136870465765    "the pressure drop when the valve is fully open (pa)";
