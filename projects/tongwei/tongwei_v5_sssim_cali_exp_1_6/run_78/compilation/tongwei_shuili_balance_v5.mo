...
parameter Real secd_pipe_v_nominal=1.206038639512768   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.5860584043609676 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49335.989821742296    "the pressure drop when the valve is fully open (pa)";
