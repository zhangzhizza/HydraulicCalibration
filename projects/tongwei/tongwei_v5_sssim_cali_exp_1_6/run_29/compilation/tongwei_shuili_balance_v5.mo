...
parameter Real secd_pipe_v_nominal=0.773332504005372   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.2828011307691026 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49095.20604496744    "the pressure drop when the valve is fully open (pa)";
