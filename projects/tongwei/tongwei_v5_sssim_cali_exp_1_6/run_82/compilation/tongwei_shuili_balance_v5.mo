...
parameter Real secd_pipe_v_nominal=3.321251025800124   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.24695936315786554 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49726.89072003554    "the pressure drop when the valve is fully open (pa)";
