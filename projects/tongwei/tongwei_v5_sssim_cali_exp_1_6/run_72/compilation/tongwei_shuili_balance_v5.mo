...
parameter Real secd_pipe_v_nominal=2.226819045851073   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.6843509728070354 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49151.55321522359    "the pressure drop when the valve is fully open (pa)";
