...
parameter Real secd_pipe_v_nominal=1.1739937889531358   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.617170184400589 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49215.4392836755    "the pressure drop when the valve is fully open (pa)";
