...
parameter Real secd_pipe_v_nominal=1.5520673408300796   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8293834842156156 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49440.408929802084    "the pressure drop when the valve is fully open (pa)";
