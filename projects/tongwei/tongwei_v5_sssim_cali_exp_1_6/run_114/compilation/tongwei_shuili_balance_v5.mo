...
parameter Real secd_pipe_v_nominal=2.9262794781611574   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.5542287501139602 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49753.69850924192    "the pressure drop when the valve is fully open (pa)";
