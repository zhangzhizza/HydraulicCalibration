...
parameter Real secd_pipe_v_nominal=0.7420009156462166   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.3409197473777408 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49716.76033041025    "the pressure drop when the valve is fully open (pa)";
