...
parameter Real secd_pipe_v_nominal=2.751317069359151   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1322607135487375 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49981.72122211274    "the pressure drop when the valve is fully open (pa)";
