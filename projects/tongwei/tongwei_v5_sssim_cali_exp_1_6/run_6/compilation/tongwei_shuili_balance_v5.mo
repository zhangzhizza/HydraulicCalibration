...
parameter Real secd_pipe_v_nominal=1.4730913109327122   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.7282326763259928 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49218.78407033065    "the pressure drop when the valve is fully open (pa)";
