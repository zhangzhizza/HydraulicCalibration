...
parameter Real secd_pipe_v_nominal=0.7117710647461157   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.6972803885498788 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49423.11114209525    "the pressure drop when the valve is fully open (pa)";
