...
parameter Real secd_pipe_v_nominal=2.186989715714987   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.4264492976808945 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49805.54071682604    "the pressure drop when the valve is fully open (pa)";
