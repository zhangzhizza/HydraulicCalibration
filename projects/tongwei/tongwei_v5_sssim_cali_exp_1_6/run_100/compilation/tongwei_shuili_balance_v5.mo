...
parameter Real secd_pipe_v_nominal=2.1577898245781224   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8491125067647871 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49021.00487376498    "the pressure drop when the valve is fully open (pa)";
