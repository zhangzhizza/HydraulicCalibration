...
parameter Real secd_pipe_v_nominal=2.8810269663526173   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7625302650412515 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49734.605012719316    "the pressure drop when the valve is fully open (pa)";
