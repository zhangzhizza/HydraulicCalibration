...
parameter Real secd_pipe_v_nominal=1.3699956969963252   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.103368915838182 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49411.68262538676    "the pressure drop when the valve is fully open (pa)";
