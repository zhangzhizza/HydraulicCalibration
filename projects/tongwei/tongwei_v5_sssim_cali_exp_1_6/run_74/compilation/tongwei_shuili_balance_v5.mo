...
parameter Real secd_pipe_v_nominal=1.248551828912815   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.7031055320735002 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49196.55840629834    "the pressure drop when the valve is fully open (pa)";
