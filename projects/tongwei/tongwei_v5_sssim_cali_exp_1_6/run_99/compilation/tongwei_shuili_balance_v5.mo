...
parameter Real secd_pipe_v_nominal=1.8273466741340738   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.7907794649332256 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49861.90603697499    "the pressure drop when the valve is fully open (pa)";
