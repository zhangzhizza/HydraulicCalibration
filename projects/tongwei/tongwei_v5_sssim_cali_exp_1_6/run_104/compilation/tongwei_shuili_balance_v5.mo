...
parameter Real secd_pipe_v_nominal=0.7669974016868444   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.719640972021496 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49007.91254514205    "the pressure drop when the valve is fully open (pa)";
