...
parameter Real secd_pipe_v_nominal=3.6875684518282252   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.8749924054550253 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49275.714081707985    "the pressure drop when the valve is fully open (pa)";
