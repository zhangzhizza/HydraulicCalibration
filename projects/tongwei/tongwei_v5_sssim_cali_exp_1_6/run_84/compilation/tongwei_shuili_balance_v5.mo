...
parameter Real secd_pipe_v_nominal=3.4388813636217135   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.9942863765966865 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49879.286551700236    "the pressure drop when the valve is fully open (pa)";
