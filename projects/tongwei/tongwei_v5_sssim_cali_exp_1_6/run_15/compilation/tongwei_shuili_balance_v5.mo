...
parameter Real secd_pipe_v_nominal=3.87647251060251   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.041684235986679 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49960.632642781784    "the pressure drop when the valve is fully open (pa)";
