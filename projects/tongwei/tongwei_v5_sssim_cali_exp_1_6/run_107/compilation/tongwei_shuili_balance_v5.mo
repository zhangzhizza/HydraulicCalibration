...
parameter Real secd_pipe_v_nominal=1.0210318314816262   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.193204642182373 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49717.181460798616    "the pressure drop when the valve is fully open (pa)";
