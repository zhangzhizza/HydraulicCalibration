...
parameter Real secd_pipe_v_nominal=1.9287536710524507   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.879160182845113 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49016.3066071641    "the pressure drop when the valve is fully open (pa)";
