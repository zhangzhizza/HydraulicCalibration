...
parameter Real secd_pipe_v_nominal=3.3742605676657567   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.8746751832298147 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49845.96045094362    "the pressure drop when the valve is fully open (pa)";
