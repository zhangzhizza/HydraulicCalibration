...
parameter Real secd_pipe_v_nominal=2.8776045456989574   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.3162954277726384 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49523.07654488468    "the pressure drop when the valve is fully open (pa)";
