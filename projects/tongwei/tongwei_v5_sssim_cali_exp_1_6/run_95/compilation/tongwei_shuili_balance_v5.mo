...
parameter Real secd_pipe_v_nominal=3.6204646891018606   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.0609540418655947 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49136.180437445444    "the pressure drop when the valve is fully open (pa)";
