...
parameter Real secd_pipe_v_nominal=1.7937201291664953   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.7755014214933391 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49145.59855809317    "the pressure drop when the valve is fully open (pa)";
