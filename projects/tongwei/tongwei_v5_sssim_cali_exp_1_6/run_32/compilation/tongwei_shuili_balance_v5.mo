...
parameter Real secd_pipe_v_nominal=2.2490062903955566   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.7094570425861613 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49637.48032170005    "the pressure drop when the valve is fully open (pa)";
