...
parameter Real secd_pipe_v_nominal=1.1455385190505196   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.3974499792472663 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49593.567479948906    "the pressure drop when the valve is fully open (pa)";
