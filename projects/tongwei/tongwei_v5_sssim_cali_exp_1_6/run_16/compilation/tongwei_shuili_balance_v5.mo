...
parameter Real secd_pipe_v_nominal=2.142888609401808   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.4844832165011206 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49428.513046904765    "the pressure drop when the valve is fully open (pa)";
