...
parameter Real secd_pipe_v_nominal=1.6388446124886975   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.23354407374231223 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49629.47432566565    "the pressure drop when the valve is fully open (pa)";
