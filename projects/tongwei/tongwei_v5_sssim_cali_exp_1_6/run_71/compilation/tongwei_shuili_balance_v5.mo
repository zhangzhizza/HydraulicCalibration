...
parameter Real secd_pipe_v_nominal=2.622529864200323   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.9466970169326143 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49936.80280282857    "the pressure drop when the valve is fully open (pa)";
