...
parameter Real secd_pipe_v_nominal=1.348796468031635   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.5190159522016864 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49173.024672645304    "the pressure drop when the valve is fully open (pa)";
