...
parameter Real secd_pipe_v_nominal=3.060256652598336   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.7074948758587165 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49389.08509876653    "the pressure drop when the valve is fully open (pa)";
