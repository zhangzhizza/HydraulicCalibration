...
parameter Real secd_pipe_v_nominal=2.8118443361229275   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.6008959088367445 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49935.60841127447    "the pressure drop when the valve is fully open (pa)";
