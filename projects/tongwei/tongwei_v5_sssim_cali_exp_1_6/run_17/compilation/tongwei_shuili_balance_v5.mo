...
parameter Real secd_pipe_v_nominal=1.2359976111081732   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7218137678550396 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49583.14108000999    "the pressure drop when the valve is fully open (pa)";
