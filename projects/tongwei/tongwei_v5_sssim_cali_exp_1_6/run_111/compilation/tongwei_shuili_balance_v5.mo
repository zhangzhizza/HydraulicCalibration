...
parameter Real secd_pipe_v_nominal=3.403169490522897   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.9409440626652454 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49349.91460635668    "the pressure drop when the valve is fully open (pa)";
