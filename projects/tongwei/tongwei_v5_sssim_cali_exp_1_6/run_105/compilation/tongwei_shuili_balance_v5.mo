...
parameter Real secd_pipe_v_nominal=2.4041420514064833   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.5011213176461977 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49867.09457551583    "the pressure drop when the valve is fully open (pa)";
