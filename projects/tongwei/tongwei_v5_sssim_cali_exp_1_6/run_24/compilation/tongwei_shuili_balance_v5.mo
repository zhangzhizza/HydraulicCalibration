...
parameter Real secd_pipe_v_nominal=3.605162177963996   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0871022888916886 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49289.55446893052    "the pressure drop when the valve is fully open (pa)";
