...
parameter Real secd_pipe_v_nominal=2.734305604187325   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.03793097978316 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49181.89573870309    "the pressure drop when the valve is fully open (pa)";
