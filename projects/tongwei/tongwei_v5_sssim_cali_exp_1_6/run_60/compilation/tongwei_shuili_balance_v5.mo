...
parameter Real secd_pipe_v_nominal=2.8019450948017552   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0923368385391299 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49317.29212064717    "the pressure drop when the valve is fully open (pa)";
