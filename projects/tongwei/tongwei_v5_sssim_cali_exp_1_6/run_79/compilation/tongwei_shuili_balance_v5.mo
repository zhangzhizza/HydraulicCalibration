...
parameter Real secd_pipe_v_nominal=1.7685678887448333   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.897473903120339 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49304.0577093565    "the pressure drop when the valve is fully open (pa)";
