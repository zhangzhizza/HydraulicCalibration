...
parameter Real secd_pipe_v_nominal=3.547543405810413   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8972056067204854 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49051.51876588232    "the pressure drop when the valve is fully open (pa)";
