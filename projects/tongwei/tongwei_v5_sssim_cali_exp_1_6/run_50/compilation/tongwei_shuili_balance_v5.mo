...
parameter Real secd_pipe_v_nominal=3.7412228816879853   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.6561548998491347 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49699.16139248194    "the pressure drop when the valve is fully open (pa)";
