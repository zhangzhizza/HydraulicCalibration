...
parameter Real secd_pipe_v_nominal=3.923845814411675   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.467733071476672 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49719.328991305534    "the pressure drop when the valve is fully open (pa)";
