...
parameter Real secd_pipe_v_nominal=1.7468825762123374   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1627837113602044 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49850.42156265098    "the pressure drop when the valve is fully open (pa)";
