...
parameter Real secd_pipe_v_nominal=1.5959742080798192   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.349572824262337 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49659.82251682234    "the pressure drop when the valve is fully open (pa)";
