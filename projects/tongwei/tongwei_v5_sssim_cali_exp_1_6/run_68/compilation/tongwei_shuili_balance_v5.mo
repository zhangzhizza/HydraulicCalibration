...
parameter Real secd_pipe_v_nominal=0.5818202719879865   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1673636181540323 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49452.02535322795    "the pressure drop when the valve is fully open (pa)";
