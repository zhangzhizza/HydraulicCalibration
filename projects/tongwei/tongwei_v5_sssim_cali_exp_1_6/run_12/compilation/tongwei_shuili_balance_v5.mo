...
parameter Real secd_pipe_v_nominal=2.737150049316083   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.5841402770345552 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49237.455757562595    "the pressure drop when the valve is fully open (pa)";
