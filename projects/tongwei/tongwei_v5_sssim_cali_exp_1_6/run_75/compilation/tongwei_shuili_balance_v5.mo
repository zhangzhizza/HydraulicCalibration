...
parameter Real secd_pipe_v_nominal=0.2274739257469601   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7002334061189663 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49317.17938269277    "the pressure drop when the valve is fully open (pa)";
