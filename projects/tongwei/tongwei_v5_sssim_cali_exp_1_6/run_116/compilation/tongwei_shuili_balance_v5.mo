...
parameter Real secd_pipe_v_nominal=0.6039407708113134   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.873344171238739 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49627.88794847407    "the pressure drop when the valve is fully open (pa)";
