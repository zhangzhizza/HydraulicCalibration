...
parameter Real secd_pipe_v_nominal=2.4990026623966832   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.879115502217992 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49207.0393475669    "the pressure drop when the valve is fully open (pa)";
