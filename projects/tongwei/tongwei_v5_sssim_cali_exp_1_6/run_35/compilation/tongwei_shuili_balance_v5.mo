...
parameter Real secd_pipe_v_nominal=2.8873898018808193   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.616346374358261 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49857.20570665052    "the pressure drop when the valve is fully open (pa)";
