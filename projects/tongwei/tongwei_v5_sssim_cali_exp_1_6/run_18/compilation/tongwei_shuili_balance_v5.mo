...
parameter Real secd_pipe_v_nominal=3.9885758928386688   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.2807737454922212 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49850.37509799386    "the pressure drop when the valve is fully open (pa)";
