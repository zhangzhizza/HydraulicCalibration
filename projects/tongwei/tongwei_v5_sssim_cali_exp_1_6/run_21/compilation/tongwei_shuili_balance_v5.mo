...
parameter Real secd_pipe_v_nominal=2.8674492216360674   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.21184238554845256 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49161.70788723252    "the pressure drop when the valve is fully open (pa)";
