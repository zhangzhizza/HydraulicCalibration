...
parameter Real secd_pipe_v_nominal=1.0428571870110601   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.506899521900004 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49112.23897978739    "the pressure drop when the valve is fully open (pa)";
