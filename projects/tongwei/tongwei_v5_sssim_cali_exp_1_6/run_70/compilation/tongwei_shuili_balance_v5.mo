...
parameter Real secd_pipe_v_nominal=3.5002947648453477   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.891393226357484 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49491.03769958248    "the pressure drop when the valve is fully open (pa)";
