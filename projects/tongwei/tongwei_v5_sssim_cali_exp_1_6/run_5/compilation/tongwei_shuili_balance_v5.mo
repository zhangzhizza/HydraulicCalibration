...
parameter Real secd_pipe_v_nominal=1.440498162024944   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.7112219764230705 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49615.33485818578    "the pressure drop when the valve is fully open (pa)";
