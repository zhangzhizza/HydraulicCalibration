...
parameter Real secd_pipe_v_nominal=2.8942198844584217   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0916550891846972 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49394.17287373119    "the pressure drop when the valve is fully open (pa)";
