...
parameter Real secd_pipe_v_nominal=1.4338210631792019   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.871859761843434 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49682.22283589807    "the pressure drop when the valve is fully open (pa)";
