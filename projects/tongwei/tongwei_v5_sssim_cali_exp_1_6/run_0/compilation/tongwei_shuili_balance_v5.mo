...
parameter Real secd_pipe_v_nominal=3.609288269472364   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.2966167109016067 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49275.71354774236    "the pressure drop when the valve is fully open (pa)";
