...
parameter Real secd_pipe_v_nominal=2.1922805931268656   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.6063574740373332 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49502.94989206052    "the pressure drop when the valve is fully open (pa)";
