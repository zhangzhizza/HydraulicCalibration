...
parameter Real secd_pipe_v_nominal=3.819774128770094   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.8750968040838094 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49637.39712018339    "the pressure drop when the valve is fully open (pa)";
