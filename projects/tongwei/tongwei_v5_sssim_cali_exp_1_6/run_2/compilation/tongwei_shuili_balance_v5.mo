...
parameter Real secd_pipe_v_nominal=1.7191755483790343   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7469929517553284 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49887.07904997136    "the pressure drop when the valve is fully open (pa)";
