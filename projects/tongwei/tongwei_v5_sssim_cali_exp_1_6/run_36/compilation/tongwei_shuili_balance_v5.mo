...
parameter Real secd_pipe_v_nominal=2.8090360647973993   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.6518270689488825 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49631.25525205205    "the pressure drop when the valve is fully open (pa)";
