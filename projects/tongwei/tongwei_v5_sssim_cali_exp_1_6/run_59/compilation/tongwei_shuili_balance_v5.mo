...
parameter Real secd_pipe_v_nominal=3.0334143624343004   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.976411165339101 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49085.45267630394    "the pressure drop when the valve is fully open (pa)";
