...
parameter Real secd_pipe_v_nominal=1.4512812208405963   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.5053924382571997 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=49064.95149803383    "the pressure drop when the valve is fully open (pa)";
