...
parameter Real secd_pipe_v_nominal=0.5662939158430063   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.6024598804996888 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=182370.84753682365    "the pressure drop when the valve is fully open (pa)";
