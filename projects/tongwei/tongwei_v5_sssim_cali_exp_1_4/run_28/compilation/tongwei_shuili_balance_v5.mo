...
parameter Real secd_pipe_v_nominal=3.602189515784511   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.9856848490428862 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=40570.307952498726    "the pressure drop when the valve is fully open (pa)";
