...
parameter Real secd_pipe_v_nominal=2.698835803976973   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.2869554106582364 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=210775.5472562979    "the pressure drop when the valve is fully open (pa)";
