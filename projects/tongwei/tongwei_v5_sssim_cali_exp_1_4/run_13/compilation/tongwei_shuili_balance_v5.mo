...
parameter Real secd_pipe_v_nominal=2.2617307648819143   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.603923223436888 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=228062.23295676298    "the pressure drop when the valve is fully open (pa)";
