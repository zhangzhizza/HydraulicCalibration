...
parameter Real secd_pipe_v_nominal=1.7933170908776166   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.3172625813744676 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=376087.0000899674    "the pressure drop when the valve is fully open (pa)";
