...
parameter Real secd_pipe_v_nominal=3.4005881980189625   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.6928711384019346 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=4647.912522777691    "the pressure drop when the valve is fully open (pa)";
