...
parameter Real secd_pipe_v_nominal=2.0632214674751697   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.388911906821841 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=238168.7897852088    "the pressure drop when the valve is fully open (pa)";
