...
parameter Real secd_pipe_v_nominal=3.9690835659210455   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.5581681029309813 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=138233.27998764528    "the pressure drop when the valve is fully open (pa)";
