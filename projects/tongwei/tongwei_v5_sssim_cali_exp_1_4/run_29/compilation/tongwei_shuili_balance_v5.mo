...
parameter Real secd_pipe_v_nominal=1.4847266022219714   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.1406429975283991 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=205062.4230502927    "the pressure drop when the valve is fully open (pa)";
