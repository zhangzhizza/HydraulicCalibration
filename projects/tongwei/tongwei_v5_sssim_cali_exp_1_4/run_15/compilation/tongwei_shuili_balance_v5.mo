...
parameter Real secd_pipe_v_nominal=1.3911297503041937   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.3597955609334846 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=186009.38025259037    "the pressure drop when the valve is fully open (pa)";
