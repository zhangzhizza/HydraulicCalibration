...
parameter Real secd_pipe_v_nominal=0.9313177480019832   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.9895687212050985 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=497958.5489033273    "the pressure drop when the valve is fully open (pa)";
