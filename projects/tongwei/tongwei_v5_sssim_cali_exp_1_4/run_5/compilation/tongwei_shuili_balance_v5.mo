...
parameter Real secd_pipe_v_nominal=1.9023939016036968   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.5230746244005693 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=463267.8421758726    "the pressure drop when the valve is fully open (pa)";
