...
parameter Real secd_pipe_v_nominal=3.9096040078581646   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4912108939613244 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=199429.31195115705    "the pressure drop when the valve is fully open (pa)";
