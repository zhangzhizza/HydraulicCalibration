...
parameter Real secd_pipe_v_nominal=3.70929000246371   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.1035911806196226 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=32478.839916620524    "the pressure drop when the valve is fully open (pa)";
