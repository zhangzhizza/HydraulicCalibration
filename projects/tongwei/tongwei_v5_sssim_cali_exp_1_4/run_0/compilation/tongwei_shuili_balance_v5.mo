...
parameter Real secd_pipe_v_nominal=3.3266987379033433   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.4996446032850002 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=489764.6682365045    "the pressure drop when the valve is fully open (pa)";
