...
parameter Real secd_pipe_v_nominal=1.3687272889314122   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.134878247780106 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=373400.76891067915    "the pressure drop when the valve is fully open (pa)";
