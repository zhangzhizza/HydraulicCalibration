...
parameter Real secd_pipe_v_nominal=2.2957051462365357   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.783616642972274 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=65362.00543315825    "the pressure drop when the valve is fully open (pa)";
