...
parameter Real secd_pipe_v_nominal=0.8071016770548298   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.8766056177202262 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=395460.4520642541    "the pressure drop when the valve is fully open (pa)";
