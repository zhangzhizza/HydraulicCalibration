...
parameter Real secd_pipe_v_nominal=1.0947713177857623   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.7590626572867567 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=31186.148191076947    "the pressure drop when the valve is fully open (pa)";
