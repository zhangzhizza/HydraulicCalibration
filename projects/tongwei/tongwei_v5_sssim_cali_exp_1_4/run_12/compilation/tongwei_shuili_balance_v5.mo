...
parameter Real secd_pipe_v_nominal=0.30993579815747535   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.614630042733902 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=341236.1231858915    "the pressure drop when the valve is fully open (pa)";
