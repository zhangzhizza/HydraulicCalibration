...
parameter Real secd_pipe_v_nominal=3.06940527704712   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.7156371915401585 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=304016.0112554292    "the pressure drop when the valve is fully open (pa)";
