...
parameter Real secd_pipe_v_nominal=2.040567329803601   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.119810030584495 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=372847.47490391403    "the pressure drop when the valve is fully open (pa)";
