...
parameter Real secd_pipe_v_nominal=2.786755492804662   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.6133261445517824 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=433776.39481307444    "the pressure drop when the valve is fully open (pa)";
