...
parameter Real secd_pipe_v_nominal=2.3443190816165034   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.7387388837682614 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=16114.183241445618    "the pressure drop when the valve is fully open (pa)";
