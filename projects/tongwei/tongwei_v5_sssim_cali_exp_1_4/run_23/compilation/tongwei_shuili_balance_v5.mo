...
parameter Real secd_pipe_v_nominal=1.8598406134764829   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.289550076897007 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=286716.47156590945    "the pressure drop when the valve is fully open (pa)";
