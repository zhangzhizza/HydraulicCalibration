...
parameter Real secd_pipe_v_nominal=2.895620795397406   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.9897917931508542 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=236695.51812443117    "the pressure drop when the valve is fully open (pa)";
