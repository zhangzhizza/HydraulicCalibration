...
parameter Real secd_pipe_v_nominal=2.581952985184647   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=1.0423604299068496 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=108726.3473302261    "the pressure drop when the valve is fully open (pa)";
