...
parameter Real secd_pipe_v_nominal=2.666894054446914   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.2564509953672586 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=343580.209033615    "the pressure drop when the valve is fully open (pa)";
