...
parameter Real secd_pipe_v_nominal=3.8447413733972127   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.035220309645146 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=146173.14656929526    "the pressure drop when the valve is fully open (pa)";
