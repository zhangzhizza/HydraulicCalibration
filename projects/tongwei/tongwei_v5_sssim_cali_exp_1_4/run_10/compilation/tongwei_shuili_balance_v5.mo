...
parameter Real secd_pipe_v_nominal=1.0150089779867897   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.101845604625401 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=158547.48591073864    "the pressure drop when the valve is fully open (pa)";
