...
parameter Real secd_pipe_v_nominal=0.773189164610306   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.2142983199122946 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=107910.08137165339    "the pressure drop when the valve is fully open (pa)";
