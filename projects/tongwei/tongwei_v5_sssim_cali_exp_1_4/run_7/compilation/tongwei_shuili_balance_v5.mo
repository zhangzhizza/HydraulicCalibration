...
parameter Real secd_pipe_v_nominal=2.4582492553833375   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=2.975533474719666 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=111939.92073981912    "the pressure drop when the valve is fully open (pa)";
