...
parameter Real secd_pipe_v_nominal=2.6285186134265937   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=3.3307478473501306 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=483307.49047932617    "the pressure drop when the valve is fully open (pa)";
