...
parameter Real secd_pipe_v_nominal=1.8893282687887043   "the water velocity of second pump(m/s)";
...
parameter Real prim_pipe_v_nominal=0.3529097289548499 "the velocity of chiller water(m/s";
...
parameter Real terminal_dpopen=140134.1160730259    "the pressure drop when the valve is fully open (pa)";
