model nb_hydr_static_v6_cali_exp4_run_16984625741560335_res1
  ...
  parameter Real chiller_pipe_len=25.55 "m";
  parameter Real chiller_v_nominal=1.43 "m/s";
...
end nb_hydr_static_v6_cali_exp4_run_16984625741560335_res1;
