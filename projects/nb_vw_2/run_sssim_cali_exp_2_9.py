...
res_dir = 'nb_hydr_static_v5_sssim_cali_exp_2_9'
param_json_path = 'calibration_param_dist_exp_2.json'# 'calibration_param_dist_exp_2.json'
sudo_pwd = '123456'
log_level = 'DEBUG'
search_fail_return = True
data_range_l = 0
data_range_h = 300
calibration_data = pd.read_csv('2020P2_calibration_data_30m_qthres0.9_bins30.csv')[data_range_l:data_range_h]
