within ;
model nb_hydr_static_v5_cali_exp2_res2
  ...
  parameter Real chiller_pipe_len=45.86 "m";
  parameter Real chiller_v_nominal=0.52 "m/s";
...
end nb_hydr_static_v5_cali_exp2_res2;
