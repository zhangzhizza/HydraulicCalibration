within ;
model nb_hydr_static_v5_cali_exp2_res3
  ...
  parameter Real chiller_pipe_len=145.2 "m";
  parameter Real chiller_v_nominal=0.62 "m/s";
...
end nb_hydr_static_v5_cali_exp2_res3;
