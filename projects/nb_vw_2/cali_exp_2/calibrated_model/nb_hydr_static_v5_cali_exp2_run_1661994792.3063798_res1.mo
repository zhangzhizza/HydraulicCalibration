within ;
model nb_hydr_static_v5_cali_exp2_res
  ...
  parameter Real chiller_pipe_len=109.6 "m";
  parameter Real chiller_v_nominal=0.76 "m/s";
...
end nb_hydr_static_v5_cali_exp2_res;
