...
mo_path = './calibrated_model/nb_hydr_static_v5_cali_exp2_run_1662133982_4002428_res1.mo'
...
np.savetxt(res_dir + os.sep + 'sim_res_testing_run_1662133982_4002428_1.csv', sim_res, delimiter = ',')