...
parameter Real chr_flow_nom=422.6917797706359 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=162400.02065574308 "Nominal Dp of each chiller (Pa)";
