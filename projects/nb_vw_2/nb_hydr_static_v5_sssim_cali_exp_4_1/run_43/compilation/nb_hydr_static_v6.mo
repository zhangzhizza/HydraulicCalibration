...
parameter Real chr_flow_nom=119.41415026797245 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=61954.09835250695 "Nominal Dp of each chiller (Pa)";
