...
parameter Real chr_flow_nom=280.9771599928528 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=179204.9262443271 "Nominal Dp of each chiller (Pa)";
