...
parameter Real chr_flow_nom=387.67333939296066 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=286931.47839370585 "Nominal Dp of each chiller (Pa)";
