...
parameter Real chr_flow_nom=524.5315122596685 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=171921.55602896243 "Nominal Dp of each chiller (Pa)";
