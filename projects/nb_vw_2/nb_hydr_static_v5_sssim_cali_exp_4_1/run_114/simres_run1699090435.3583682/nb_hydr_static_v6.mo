...
parameter Real chr_flow_nom=104.43483510776821 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=63666.264155909055 "Nominal Dp of each chiller (Pa)";
