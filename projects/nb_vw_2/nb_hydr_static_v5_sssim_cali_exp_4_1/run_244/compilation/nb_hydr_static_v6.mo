...
parameter Real chr_flow_nom=946.0556772470987 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=279184.33979211765 "Nominal Dp of each chiller (Pa)";
