...
parameter Real chr_flow_nom=293.2849239472939 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=179614.9367325411 "Nominal Dp of each chiller (Pa)";
