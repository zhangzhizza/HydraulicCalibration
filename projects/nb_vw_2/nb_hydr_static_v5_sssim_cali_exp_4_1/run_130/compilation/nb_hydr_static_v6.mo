...
parameter Real chr_flow_nom=996.6683396501438 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=136037.8090570357 "Nominal Dp of each chiller (Pa)";
