...
parameter Real chr_flow_nom=974.9388745035817 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=265471.96937051753 "Nominal Dp of each chiller (Pa)";
