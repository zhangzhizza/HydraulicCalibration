...
parameter Real chr_flow_nom=841.1509092465391 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=274914.78007711767 "Nominal Dp of each chiller (Pa)";
