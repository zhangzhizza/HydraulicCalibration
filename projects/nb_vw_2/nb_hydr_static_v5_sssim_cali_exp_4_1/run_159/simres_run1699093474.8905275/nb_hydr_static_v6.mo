...
parameter Real chr_flow_nom=152.30153924239295 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=45596.586997333034 "Nominal Dp of each chiller (Pa)";
