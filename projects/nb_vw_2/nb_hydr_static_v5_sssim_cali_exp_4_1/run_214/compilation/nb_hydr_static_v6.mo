...
parameter Real chr_flow_nom=472.05873219254806 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=197346.0103772803 "Nominal Dp of each chiller (Pa)";
