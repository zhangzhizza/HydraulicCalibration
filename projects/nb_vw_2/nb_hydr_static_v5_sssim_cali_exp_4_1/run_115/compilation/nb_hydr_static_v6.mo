...
parameter Real chr_flow_nom=316.48947006023036 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=67633.25448294236 "Nominal Dp of each chiller (Pa)";
