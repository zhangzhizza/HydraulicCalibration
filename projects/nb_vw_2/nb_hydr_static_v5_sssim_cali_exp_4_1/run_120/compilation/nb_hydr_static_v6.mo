...
parameter Real chr_flow_nom=367.9018364835958 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=104705.14680163182 "Nominal Dp of each chiller (Pa)";
