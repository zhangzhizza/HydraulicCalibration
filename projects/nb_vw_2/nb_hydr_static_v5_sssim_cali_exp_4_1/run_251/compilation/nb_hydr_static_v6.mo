...
parameter Real chr_flow_nom=442.90981924365957 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=41959.03853593572 "Nominal Dp of each chiller (Pa)";
