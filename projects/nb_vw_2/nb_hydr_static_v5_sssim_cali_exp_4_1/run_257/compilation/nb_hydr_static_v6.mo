...
parameter Real chr_flow_nom=404.6419516518222 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=281227.2142238741 "Nominal Dp of each chiller (Pa)";
