...
parameter Real chr_flow_nom=558.7178523333009 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=185871.6252549097 "Nominal Dp of each chiller (Pa)";
