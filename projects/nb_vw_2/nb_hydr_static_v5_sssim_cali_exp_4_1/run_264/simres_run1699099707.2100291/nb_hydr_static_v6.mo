...
parameter Real chr_flow_nom=117.82746974042294 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=141644.52292545812 "Nominal Dp of each chiller (Pa)";
