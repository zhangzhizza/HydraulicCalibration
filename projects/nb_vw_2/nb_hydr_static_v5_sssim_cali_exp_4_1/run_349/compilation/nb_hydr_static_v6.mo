...
parameter Real chr_flow_nom=525.8131182157035 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=278252.23866880406 "Nominal Dp of each chiller (Pa)";
