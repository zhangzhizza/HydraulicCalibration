...
parameter Real chr_flow_nom=505.1230010085426 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=192271.15022289846 "Nominal Dp of each chiller (Pa)";
