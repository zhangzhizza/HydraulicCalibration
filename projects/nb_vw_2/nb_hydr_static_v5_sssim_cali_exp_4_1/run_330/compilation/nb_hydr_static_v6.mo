...
parameter Real chr_flow_nom=740.0882560216722 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=51355.78480005038 "Nominal Dp of each chiller (Pa)";
