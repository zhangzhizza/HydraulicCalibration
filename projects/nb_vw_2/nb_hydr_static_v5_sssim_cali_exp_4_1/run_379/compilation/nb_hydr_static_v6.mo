...
parameter Real chr_flow_nom=872.6205382991269 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=119509.9997075301 "Nominal Dp of each chiller (Pa)";
