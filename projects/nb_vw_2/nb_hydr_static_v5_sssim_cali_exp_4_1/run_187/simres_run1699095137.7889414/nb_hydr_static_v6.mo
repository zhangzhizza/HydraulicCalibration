...
parameter Real chr_flow_nom=999.5663356445319 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=50106.104588249465 "Nominal Dp of each chiller (Pa)";
