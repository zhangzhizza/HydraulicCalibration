...
parameter Real chr_flow_nom=474.3254543025336 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=100712.06084807905 "Nominal Dp of each chiller (Pa)";
