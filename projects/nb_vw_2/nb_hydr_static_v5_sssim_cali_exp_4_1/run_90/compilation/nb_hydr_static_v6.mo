...
parameter Real chr_flow_nom=361.77180571133874 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=69902.12942861256 "Nominal Dp of each chiller (Pa)";
