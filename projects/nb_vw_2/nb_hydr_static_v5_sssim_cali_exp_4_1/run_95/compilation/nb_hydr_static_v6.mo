...
parameter Real chr_flow_nom=443.1749201050698 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=241355.32526632145 "Nominal Dp of each chiller (Pa)";
