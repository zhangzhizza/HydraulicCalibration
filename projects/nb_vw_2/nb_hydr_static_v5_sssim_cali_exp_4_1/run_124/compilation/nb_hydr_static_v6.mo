...
parameter Real chr_flow_nom=673.0409962250337 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=142720.25380342858 "Nominal Dp of each chiller (Pa)";
