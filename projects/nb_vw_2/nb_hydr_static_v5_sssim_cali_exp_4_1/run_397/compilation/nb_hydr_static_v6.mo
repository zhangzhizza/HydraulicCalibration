...
parameter Real chr_flow_nom=643.9380058692262 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=141410.2423530571 "Nominal Dp of each chiller (Pa)";
