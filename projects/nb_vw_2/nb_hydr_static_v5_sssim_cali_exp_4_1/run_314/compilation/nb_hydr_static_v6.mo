...
parameter Real chr_flow_nom=469.67203705998173 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=58277.755628765575 "Nominal Dp of each chiller (Pa)";
