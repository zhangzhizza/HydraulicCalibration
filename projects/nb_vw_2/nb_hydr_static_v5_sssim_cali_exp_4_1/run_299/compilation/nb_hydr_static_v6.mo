...
parameter Real chr_flow_nom=173.43188461712901 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=234649.04908583616 "Nominal Dp of each chiller (Pa)";
