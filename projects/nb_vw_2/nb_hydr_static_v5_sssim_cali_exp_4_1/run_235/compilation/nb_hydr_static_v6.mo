...
parameter Real chr_flow_nom=612.1186848108381 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=160783.1622722981 "Nominal Dp of each chiller (Pa)";
