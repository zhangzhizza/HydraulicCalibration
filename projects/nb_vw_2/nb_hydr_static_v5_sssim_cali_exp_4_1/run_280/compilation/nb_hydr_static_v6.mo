...
parameter Real chr_flow_nom=846.9440421807437 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=160822.9138901695 "Nominal Dp of each chiller (Pa)";
