...
parameter Real chr_flow_nom=552.5602185360526 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=104836.8618888877 "Nominal Dp of each chiller (Pa)";
