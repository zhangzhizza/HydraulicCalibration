...
parameter Real chr_flow_nom=735.5179300673591 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=252022.05353651775 "Nominal Dp of each chiller (Pa)";
