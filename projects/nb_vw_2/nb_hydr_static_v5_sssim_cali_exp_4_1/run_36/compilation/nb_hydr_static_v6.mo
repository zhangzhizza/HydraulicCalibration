...
parameter Real chr_flow_nom=755.6426013268258 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=59490.13855172209 "Nominal Dp of each chiller (Pa)";
