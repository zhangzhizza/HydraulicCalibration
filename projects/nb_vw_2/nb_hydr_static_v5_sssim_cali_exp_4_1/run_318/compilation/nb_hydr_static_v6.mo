...
parameter Real chr_flow_nom=209.67669301129544 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=262325.31718625536 "Nominal Dp of each chiller (Pa)";
