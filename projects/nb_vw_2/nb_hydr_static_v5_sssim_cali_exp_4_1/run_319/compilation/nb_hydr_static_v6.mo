...
parameter Real chr_flow_nom=487.34813558487974 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=89956.38678099788 "Nominal Dp of each chiller (Pa)";
