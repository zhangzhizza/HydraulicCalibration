...
parameter Real chr_flow_nom=541.3030509780082 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=159499.61987770515 "Nominal Dp of each chiller (Pa)";
