...
parameter Real chr_flow_nom=800.3146569014464 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=292960.38765976403 "Nominal Dp of each chiller (Pa)";
