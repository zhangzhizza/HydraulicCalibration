...
parameter Real chr_flow_nom=558.3888857921796 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=159939.56355186808 "Nominal Dp of each chiller (Pa)";
