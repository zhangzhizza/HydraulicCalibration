...
parameter Real chr_flow_nom=388.7155517115637 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=62196.63555271873 "Nominal Dp of each chiller (Pa)";
