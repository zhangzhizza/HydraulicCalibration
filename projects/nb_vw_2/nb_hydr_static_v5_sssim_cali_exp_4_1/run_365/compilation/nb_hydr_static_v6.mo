...
parameter Real chr_flow_nom=594.0988942447547 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=208701.01486497713 "Nominal Dp of each chiller (Pa)";
