...
parameter Real chr_flow_nom=297.6349724540697 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=253070.29362946132 "Nominal Dp of each chiller (Pa)";
