...
parameter Real chr_flow_nom=864.6657868602716 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=287367.2239411571 "Nominal Dp of each chiller (Pa)";
