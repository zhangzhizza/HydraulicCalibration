...
parameter Real chr_flow_nom=717.4896316791722 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=150712.96891415477 "Nominal Dp of each chiller (Pa)";
