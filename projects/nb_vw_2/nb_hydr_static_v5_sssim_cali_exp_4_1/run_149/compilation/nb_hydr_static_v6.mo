...
parameter Real chr_flow_nom=975.2417458438964 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=164479.2327461409 "Nominal Dp of each chiller (Pa)";
