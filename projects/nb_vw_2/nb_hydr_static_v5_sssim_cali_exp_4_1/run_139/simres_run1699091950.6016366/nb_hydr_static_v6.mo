...
parameter Real chr_flow_nom=124.25477545881887 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=205136.08470828432 "Nominal Dp of each chiller (Pa)";
