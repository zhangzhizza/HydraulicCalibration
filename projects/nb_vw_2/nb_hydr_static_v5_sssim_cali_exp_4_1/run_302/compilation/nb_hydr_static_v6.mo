...
parameter Real chr_flow_nom=647.8093540596743 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=168111.48648864555 "Nominal Dp of each chiller (Pa)";
