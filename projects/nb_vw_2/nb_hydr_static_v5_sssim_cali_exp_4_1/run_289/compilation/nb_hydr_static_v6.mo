...
parameter Real chr_flow_nom=440.9087811205037 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=162999.65029885847 "Nominal Dp of each chiller (Pa)";
