...
parameter Real chr_flow_nom=316.5820804095916 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=283458.0001385326 "Nominal Dp of each chiller (Pa)";
