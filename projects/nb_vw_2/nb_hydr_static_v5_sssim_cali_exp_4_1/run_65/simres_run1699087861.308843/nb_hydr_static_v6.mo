...
parameter Real chr_flow_nom=499.93899318031544 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=160146.58316369553 "Nominal Dp of each chiller (Pa)";
