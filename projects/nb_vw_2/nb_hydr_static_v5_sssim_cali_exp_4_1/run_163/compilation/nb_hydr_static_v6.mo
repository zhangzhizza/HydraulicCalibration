...
parameter Real chr_flow_nom=874.8351589780453 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=267211.55181667255 "Nominal Dp of each chiller (Pa)";
