...
parameter Real chr_flow_nom=486.90061781539123 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=31502.83532036444 "Nominal Dp of each chiller (Pa)";
