...
parameter Real chr_flow_nom=427.55481566668516 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=78820.14918734935 "Nominal Dp of each chiller (Pa)";
