...
parameter Real chr_flow_nom=291.2708316484814 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=281352.1381276826 "Nominal Dp of each chiller (Pa)";
