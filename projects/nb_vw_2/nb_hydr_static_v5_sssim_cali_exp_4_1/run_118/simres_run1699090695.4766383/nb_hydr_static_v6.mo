...
parameter Real chr_flow_nom=873.3518911910651 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=254973.4007853719 "Nominal Dp of each chiller (Pa)";
