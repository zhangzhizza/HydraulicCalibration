...
parameter Real chr_flow_nom=439.6938831298952 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=170604.85733784636 "Nominal Dp of each chiller (Pa)";
