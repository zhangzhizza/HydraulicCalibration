...
parameter Real chr_flow_nom=263.9018151985973 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=72194.68791425432 "Nominal Dp of each chiller (Pa)";
