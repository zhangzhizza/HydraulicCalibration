...
parameter Real chr_flow_nom=885.8547182265099 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=42585.44389602486 "Nominal Dp of each chiller (Pa)";
