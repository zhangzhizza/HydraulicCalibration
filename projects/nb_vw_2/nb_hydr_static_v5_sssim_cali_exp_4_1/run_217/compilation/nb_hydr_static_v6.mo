...
parameter Real chr_flow_nom=493.1842735379173 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=99805.78789160882 "Nominal Dp of each chiller (Pa)";
