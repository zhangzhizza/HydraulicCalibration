...
parameter Real chr_flow_nom=389.4022654077289 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=127280.22864044287 "Nominal Dp of each chiller (Pa)";
