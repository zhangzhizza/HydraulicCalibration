...
parameter Real chr_flow_nom=562.8607413001935 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=189281.87375132806 "Nominal Dp of each chiller (Pa)";
