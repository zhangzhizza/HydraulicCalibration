...
parameter Real chr_flow_nom=132.67521387787514 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=285699.4767736119 "Nominal Dp of each chiller (Pa)";
