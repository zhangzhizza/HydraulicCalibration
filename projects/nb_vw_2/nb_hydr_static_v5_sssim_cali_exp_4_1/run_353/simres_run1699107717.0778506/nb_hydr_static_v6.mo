...
parameter Real chr_flow_nom=800.588027645337 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=13927.926403161959 "Nominal Dp of each chiller (Pa)";
