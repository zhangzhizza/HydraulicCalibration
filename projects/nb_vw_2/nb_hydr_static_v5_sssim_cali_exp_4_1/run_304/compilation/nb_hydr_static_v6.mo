...
parameter Real chr_flow_nom=655.871229662547 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=261458.62622637217 "Nominal Dp of each chiller (Pa)";
