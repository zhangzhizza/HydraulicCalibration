...
parameter Real chr_flow_nom=896.4385072418272 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=32223.187374295314 "Nominal Dp of each chiller (Pa)";
