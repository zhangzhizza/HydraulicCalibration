...
parameter Real chr_flow_nom=566.3140537511015 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=191135.42056023955 "Nominal Dp of each chiller (Pa)";
