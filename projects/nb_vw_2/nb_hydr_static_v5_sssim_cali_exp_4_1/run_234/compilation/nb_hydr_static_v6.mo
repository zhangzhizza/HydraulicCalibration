...
parameter Real chr_flow_nom=741.8200714980799 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=179278.80800034775 "Nominal Dp of each chiller (Pa)";
