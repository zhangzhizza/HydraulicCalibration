...
parameter Real chr_flow_nom=600.8799771841436 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=255284.89188660381 "Nominal Dp of each chiller (Pa)";
