...
parameter Real chr_flow_nom=958.6335604305574 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=201413.60925448648 "Nominal Dp of each chiller (Pa)";
