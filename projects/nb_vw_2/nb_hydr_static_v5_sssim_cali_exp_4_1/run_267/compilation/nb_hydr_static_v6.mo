...
parameter Real chr_flow_nom=742.3218422160969 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=265638.26873246697 "Nominal Dp of each chiller (Pa)";
