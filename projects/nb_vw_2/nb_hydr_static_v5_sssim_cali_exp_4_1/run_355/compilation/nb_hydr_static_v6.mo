...
parameter Real chr_flow_nom=468.8436763156143 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=195284.56471322587 "Nominal Dp of each chiller (Pa)";
