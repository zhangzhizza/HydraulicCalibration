...
parameter Real chr_flow_nom=753.8752674597032 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=48176.26505789876 "Nominal Dp of each chiller (Pa)";
