...
parameter Real chr_flow_nom=230.13799466038 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=194167.87399082052 "Nominal Dp of each chiller (Pa)";
