...
parameter Real chr_flow_nom=378.3366088285187 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=296661.72190915805 "Nominal Dp of each chiller (Pa)";
