...
parameter Real chr_flow_nom=382.2318959297873 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=258526.06443298594 "Nominal Dp of each chiller (Pa)";
