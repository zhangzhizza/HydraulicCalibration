...
parameter Real chr_flow_nom=269.4290522345886 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=168250.87821450518 "Nominal Dp of each chiller (Pa)";
