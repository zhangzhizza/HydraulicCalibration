...
parameter Real chr_flow_nom=401.64891386095604 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=167430.69261677904 "Nominal Dp of each chiller (Pa)";
