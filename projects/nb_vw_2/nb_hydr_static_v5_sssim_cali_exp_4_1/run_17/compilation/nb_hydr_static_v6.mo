...
parameter Real chr_flow_nom=882.7316115719018 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=61937.25008311269 "Nominal Dp of each chiller (Pa)";
