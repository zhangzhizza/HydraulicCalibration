...
parameter Real chr_flow_nom=818.4556707277262 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=175636.3240829192 "Nominal Dp of each chiller (Pa)";
