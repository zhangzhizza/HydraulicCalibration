...
parameter Real chr_flow_nom=902.0356638622053 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=26459.021504243112 "Nominal Dp of each chiller (Pa)";
