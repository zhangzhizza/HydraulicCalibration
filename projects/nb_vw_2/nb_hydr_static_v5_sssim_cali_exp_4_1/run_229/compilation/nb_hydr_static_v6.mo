...
parameter Real chr_flow_nom=795.4465197252348 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=157604.02231777893 "Nominal Dp of each chiller (Pa)";
