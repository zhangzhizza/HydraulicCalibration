...
parameter Real chr_flow_nom=291.8017578445165 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=138262.72130910977 "Nominal Dp of each chiller (Pa)";
