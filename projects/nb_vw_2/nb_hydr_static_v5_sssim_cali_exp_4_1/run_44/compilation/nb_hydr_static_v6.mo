...
parameter Real chr_flow_nom=502.07645439929945 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=55346.02658694458 "Nominal Dp of each chiller (Pa)";
