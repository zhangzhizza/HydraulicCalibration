...
parameter Real chr_flow_nom=678.2993745131844 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=127191.4651884674 "Nominal Dp of each chiller (Pa)";
