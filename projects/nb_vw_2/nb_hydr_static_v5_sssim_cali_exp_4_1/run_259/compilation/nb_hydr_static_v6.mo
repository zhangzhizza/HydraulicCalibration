...
parameter Real chr_flow_nom=293.78219235786264 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=96043.03266867733 "Nominal Dp of each chiller (Pa)";
