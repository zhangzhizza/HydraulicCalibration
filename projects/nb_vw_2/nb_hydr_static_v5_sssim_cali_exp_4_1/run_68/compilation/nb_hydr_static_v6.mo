...
parameter Real chr_flow_nom=555.6555792127385 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=148112.84308047558 "Nominal Dp of each chiller (Pa)";
