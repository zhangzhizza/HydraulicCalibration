...
parameter Real chr_flow_nom=572.6378209843193 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=84620.13390966663 "Nominal Dp of each chiller (Pa)";
