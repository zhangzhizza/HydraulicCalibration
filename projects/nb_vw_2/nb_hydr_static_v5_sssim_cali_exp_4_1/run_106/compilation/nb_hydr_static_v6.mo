...
parameter Real chr_flow_nom=252.27196209680937 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=35201.91183260048 "Nominal Dp of each chiller (Pa)";
