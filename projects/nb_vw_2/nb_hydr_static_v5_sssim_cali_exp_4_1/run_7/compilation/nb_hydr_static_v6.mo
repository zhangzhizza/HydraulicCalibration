...
parameter Real chr_flow_nom=794.9265220370753 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=200550.84788525885 "Nominal Dp of each chiller (Pa)";
