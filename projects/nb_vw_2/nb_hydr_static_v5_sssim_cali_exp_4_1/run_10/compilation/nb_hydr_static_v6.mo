...
parameter Real chr_flow_nom=836.6360752567397 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=51133.90160432939 "Nominal Dp of each chiller (Pa)";
