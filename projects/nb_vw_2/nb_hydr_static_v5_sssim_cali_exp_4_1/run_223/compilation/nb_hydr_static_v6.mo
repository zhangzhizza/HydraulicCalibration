...
parameter Real chr_flow_nom=174.83996480591983 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=145086.83402443584 "Nominal Dp of each chiller (Pa)";
