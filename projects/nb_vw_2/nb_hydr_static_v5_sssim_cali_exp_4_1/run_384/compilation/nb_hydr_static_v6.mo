...
parameter Real chr_flow_nom=770.5713619296204 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=200982.7111887148 "Nominal Dp of each chiller (Pa)";
