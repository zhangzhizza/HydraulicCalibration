...
parameter Real chr_flow_nom=460.1138937557963 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=108492.6544523241 "Nominal Dp of each chiller (Pa)";
