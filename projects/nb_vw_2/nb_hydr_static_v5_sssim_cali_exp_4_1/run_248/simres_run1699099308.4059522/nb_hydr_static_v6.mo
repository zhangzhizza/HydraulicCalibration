...
parameter Real chr_flow_nom=963.0390673157685 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=84825.74279757509 "Nominal Dp of each chiller (Pa)";
