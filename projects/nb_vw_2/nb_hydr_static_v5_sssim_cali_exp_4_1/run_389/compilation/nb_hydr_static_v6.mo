...
parameter Real chr_flow_nom=342.18671890208793 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=145852.62503293875 "Nominal Dp of each chiller (Pa)";
