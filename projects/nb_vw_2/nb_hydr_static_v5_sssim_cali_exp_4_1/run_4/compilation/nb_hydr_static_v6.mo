...
parameter Real chr_flow_nom=420.902402972555 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=124093.72878505303 "Nominal Dp of each chiller (Pa)";
