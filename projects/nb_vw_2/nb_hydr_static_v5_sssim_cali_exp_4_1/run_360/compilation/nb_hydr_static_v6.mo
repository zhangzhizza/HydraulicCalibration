...
parameter Real chr_flow_nom=565.0103649405723 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=92332.14751831433 "Nominal Dp of each chiller (Pa)";
