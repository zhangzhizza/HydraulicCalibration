...
parameter Real chr_flow_nom=628.0346442320947 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=125551.88534074949 "Nominal Dp of each chiller (Pa)";
