...
parameter Real chr_flow_nom=505.40022465343776 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=214262.74219059243 "Nominal Dp of each chiller (Pa)";
