...
parameter Real chr_flow_nom=497.6010720077073 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=129934.13391083274 "Nominal Dp of each chiller (Pa)";
