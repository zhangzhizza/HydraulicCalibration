...
parameter Real chr_flow_nom=284.0334660037514 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=220877.5215562437 "Nominal Dp of each chiller (Pa)";
