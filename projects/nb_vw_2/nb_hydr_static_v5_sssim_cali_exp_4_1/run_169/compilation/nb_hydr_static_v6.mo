...
parameter Real chr_flow_nom=381.0692899733071 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=159609.34792101482 "Nominal Dp of each chiller (Pa)";
