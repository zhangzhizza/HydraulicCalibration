...
parameter Real chr_flow_nom=210.6125252685119 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=31049.06863595378 "Nominal Dp of each chiller (Pa)";
