...
parameter Real chr_flow_nom=114.96957232163862 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=230725.7112119348 "Nominal Dp of each chiller (Pa)";
