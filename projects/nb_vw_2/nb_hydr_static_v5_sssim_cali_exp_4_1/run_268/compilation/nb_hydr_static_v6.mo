...
parameter Real chr_flow_nom=512.6474452330632 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=176597.7215458457 "Nominal Dp of each chiller (Pa)";
