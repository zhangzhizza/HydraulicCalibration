...
parameter Real chr_flow_nom=193.13587380106244 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=262397.15434361354 "Nominal Dp of each chiller (Pa)";
