...
parameter Real chr_flow_nom=526.6416959262369 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=258238.16891828185 "Nominal Dp of each chiller (Pa)";
