...
parameter Real chr_flow_nom=492.0131908493828 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=152040.8830889305 "Nominal Dp of each chiller (Pa)";
