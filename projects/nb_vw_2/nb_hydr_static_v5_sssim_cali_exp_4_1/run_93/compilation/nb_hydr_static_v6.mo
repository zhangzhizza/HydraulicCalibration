...
parameter Real chr_flow_nom=180.43479448479502 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=277228.7206964554 "Nominal Dp of each chiller (Pa)";
