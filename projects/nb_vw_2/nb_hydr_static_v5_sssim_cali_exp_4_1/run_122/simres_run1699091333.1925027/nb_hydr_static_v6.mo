...
parameter Real chr_flow_nom=208.79733128588583 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=53497.04206881791 "Nominal Dp of each chiller (Pa)";
