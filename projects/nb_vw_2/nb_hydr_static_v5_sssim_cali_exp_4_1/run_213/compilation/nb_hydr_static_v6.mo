...
parameter Real chr_flow_nom=353.94572594827184 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=296925.0211812146 "Nominal Dp of each chiller (Pa)";
