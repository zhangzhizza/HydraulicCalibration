...
parameter Real chr_flow_nom=232.04097161341153 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=23970.56043366195 "Nominal Dp of each chiller (Pa)";
