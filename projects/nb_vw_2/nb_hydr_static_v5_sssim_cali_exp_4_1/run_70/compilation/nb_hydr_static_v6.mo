...
parameter Real chr_flow_nom=793.7109585747054 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=293732.9191094724 "Nominal Dp of each chiller (Pa)";
