...
parameter Real chr_flow_nom=139.57067192276605 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=13993.56554569958 "Nominal Dp of each chiller (Pa)";
