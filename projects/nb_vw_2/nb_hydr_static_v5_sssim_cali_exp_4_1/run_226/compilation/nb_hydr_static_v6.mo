...
parameter Real chr_flow_nom=598.4611668366156 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=40497.528742917784 "Nominal Dp of each chiller (Pa)";
