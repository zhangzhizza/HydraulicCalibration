...
parameter Real chr_flow_nom=752.4066209669666 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=260980.00533853887 "Nominal Dp of each chiller (Pa)";
