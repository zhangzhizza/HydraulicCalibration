...
parameter Real chr_flow_nom=943.3970883872518 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=151431.43365777534 "Nominal Dp of each chiller (Pa)";
