...
parameter Real chr_flow_nom=633.8725258974724 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=280438.1722764391 "Nominal Dp of each chiller (Pa)";
