...
parameter Real chr_flow_nom=702.2010746385653 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=168746.69479168922 "Nominal Dp of each chiller (Pa)";
