...
parameter Real chr_flow_nom=995.0402328247077 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=17118.485764101486 "Nominal Dp of each chiller (Pa)";
