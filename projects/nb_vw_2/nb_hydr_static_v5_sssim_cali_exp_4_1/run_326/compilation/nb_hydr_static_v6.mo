...
parameter Real chr_flow_nom=918.3562140966103 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=132668.5991184356 "Nominal Dp of each chiller (Pa)";
