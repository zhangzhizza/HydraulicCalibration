...
parameter Real chr_flow_nom=979.4031668117066 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=40192.74266121885 "Nominal Dp of each chiller (Pa)";
