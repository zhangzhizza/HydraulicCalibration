...
parameter Real chr_flow_nom=521.2684702440501 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=125153.45592068514 "Nominal Dp of each chiller (Pa)";
