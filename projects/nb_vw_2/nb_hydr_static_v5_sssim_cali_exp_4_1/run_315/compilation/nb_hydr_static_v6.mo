...
parameter Real chr_flow_nom=834.6998755064054 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=195237.2619859648 "Nominal Dp of each chiller (Pa)";
