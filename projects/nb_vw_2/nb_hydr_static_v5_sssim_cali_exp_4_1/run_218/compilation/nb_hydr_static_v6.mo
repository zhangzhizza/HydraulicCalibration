...
parameter Real chr_flow_nom=513.5065463365662 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=172386.41479078223 "Nominal Dp of each chiller (Pa)";
