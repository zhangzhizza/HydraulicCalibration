...
parameter Real chr_flow_nom=223.12616916571972 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=228722.06092518088 "Nominal Dp of each chiller (Pa)";
