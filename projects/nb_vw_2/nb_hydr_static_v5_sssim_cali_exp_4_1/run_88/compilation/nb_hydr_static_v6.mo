...
parameter Real chr_flow_nom=830.4163960703302 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=176563.92474440383 "Nominal Dp of each chiller (Pa)";
