...
parameter Real chr_flow_nom=143.2409618075352 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=182528.5454849922 "Nominal Dp of each chiller (Pa)";
