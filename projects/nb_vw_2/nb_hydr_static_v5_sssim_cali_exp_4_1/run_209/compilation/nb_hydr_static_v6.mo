...
parameter Real chr_flow_nom=360.0140583336074 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=250989.3834884179 "Nominal Dp of each chiller (Pa)";
