...
parameter Real chr_flow_nom=626.7705202787706 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=88206.01260019038 "Nominal Dp of each chiller (Pa)";
