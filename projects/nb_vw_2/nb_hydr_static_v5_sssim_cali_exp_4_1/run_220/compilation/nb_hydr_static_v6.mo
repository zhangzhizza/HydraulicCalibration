...
parameter Real chr_flow_nom=376.63541096998057 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=168048.9779000239 "Nominal Dp of each chiller (Pa)";
