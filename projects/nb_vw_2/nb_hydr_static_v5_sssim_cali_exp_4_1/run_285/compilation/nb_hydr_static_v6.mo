...
parameter Real chr_flow_nom=826.2797575010331 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=16657.642086903747 "Nominal Dp of each chiller (Pa)";
