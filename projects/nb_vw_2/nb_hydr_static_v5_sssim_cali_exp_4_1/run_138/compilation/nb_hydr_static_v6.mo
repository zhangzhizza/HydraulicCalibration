...
parameter Real chr_flow_nom=599.2900040880952 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=202793.2509413458 "Nominal Dp of each chiller (Pa)";
