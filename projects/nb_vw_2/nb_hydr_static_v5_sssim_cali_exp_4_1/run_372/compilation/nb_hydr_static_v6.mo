...
parameter Real chr_flow_nom=828.4728258392613 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=176496.2389972575 "Nominal Dp of each chiller (Pa)";
