...
parameter Real chr_flow_nom=785.2837765327672 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=128405.92921201799 "Nominal Dp of each chiller (Pa)";
