...
parameter Real chr_flow_nom=981.1136844041623 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=205697.18155366325 "Nominal Dp of each chiller (Pa)";
