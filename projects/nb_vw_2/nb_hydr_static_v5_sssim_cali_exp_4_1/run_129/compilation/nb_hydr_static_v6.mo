...
parameter Real chr_flow_nom=171.05308968766724 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=76713.83781516369 "Nominal Dp of each chiller (Pa)";
