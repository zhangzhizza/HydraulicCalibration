...
parameter Real chr_flow_nom=777.8114234399628 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=152052.80322842364 "Nominal Dp of each chiller (Pa)";
