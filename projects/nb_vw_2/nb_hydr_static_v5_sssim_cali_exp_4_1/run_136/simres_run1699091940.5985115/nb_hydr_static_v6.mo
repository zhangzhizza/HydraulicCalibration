...
parameter Real chr_flow_nom=271.04948973287105 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=209551.31480410224 "Nominal Dp of each chiller (Pa)";
