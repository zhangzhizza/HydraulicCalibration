...
parameter Real chr_flow_nom=740.4081983788067 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=89024.49945632766 "Nominal Dp of each chiller (Pa)";
