...
parameter Real chr_flow_nom=373.4222153212856 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=244702.59145911396 "Nominal Dp of each chiller (Pa)";
