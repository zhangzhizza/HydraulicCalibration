...
parameter Real chr_flow_nom=532.0124597553994 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=165597.5287857582 "Nominal Dp of each chiller (Pa)";
