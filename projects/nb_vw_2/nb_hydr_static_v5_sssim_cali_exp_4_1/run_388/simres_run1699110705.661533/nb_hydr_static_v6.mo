...
parameter Real chr_flow_nom=221.70386551944335 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=99718.57547054939 "Nominal Dp of each chiller (Pa)";
