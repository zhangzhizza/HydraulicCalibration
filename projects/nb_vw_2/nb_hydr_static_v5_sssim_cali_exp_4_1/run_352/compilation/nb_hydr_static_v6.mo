...
parameter Real chr_flow_nom=792.3898195985008 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=135215.20889695574 "Nominal Dp of each chiller (Pa)";
