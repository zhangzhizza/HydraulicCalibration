...
parameter Real chr_flow_nom=910.8498732769244 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=100494.09547317124 "Nominal Dp of each chiller (Pa)";
