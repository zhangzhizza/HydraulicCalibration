...
parameter Real chr_flow_nom=331.3560735477239 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=185095.7791784597 "Nominal Dp of each chiller (Pa)";
