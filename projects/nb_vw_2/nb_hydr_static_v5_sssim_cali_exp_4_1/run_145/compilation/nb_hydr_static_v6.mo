...
parameter Real chr_flow_nom=969.1140088188436 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=198576.43142612287 "Nominal Dp of each chiller (Pa)";
