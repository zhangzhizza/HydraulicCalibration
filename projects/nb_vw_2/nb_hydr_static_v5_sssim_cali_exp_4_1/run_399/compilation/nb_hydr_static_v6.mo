...
parameter Real chr_flow_nom=964.5909448931465 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=264234.62027586094 "Nominal Dp of each chiller (Pa)";
