...
parameter Real chr_flow_nom=312.8464116484594 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=42296.77006543029 "Nominal Dp of each chiller (Pa)";
