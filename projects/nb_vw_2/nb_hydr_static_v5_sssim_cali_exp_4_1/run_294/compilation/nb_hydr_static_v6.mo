...
parameter Real chr_flow_nom=676.4467576791336 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=78249.25569842185 "Nominal Dp of each chiller (Pa)";
