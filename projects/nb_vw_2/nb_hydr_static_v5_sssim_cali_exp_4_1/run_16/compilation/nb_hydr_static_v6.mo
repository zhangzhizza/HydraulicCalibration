...
parameter Real chr_flow_nom=671.0129403312166 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=220570.21704128783 "Nominal Dp of each chiller (Pa)";
