...
parameter Real chr_flow_nom=808.1982581434646 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=214794.19569086956 "Nominal Dp of each chiller (Pa)";
