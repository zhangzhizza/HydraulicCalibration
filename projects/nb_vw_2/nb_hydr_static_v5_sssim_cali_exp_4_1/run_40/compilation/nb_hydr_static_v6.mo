...
parameter Real chr_flow_nom=812.6560432740722 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=163254.14136311435 "Nominal Dp of each chiller (Pa)";
