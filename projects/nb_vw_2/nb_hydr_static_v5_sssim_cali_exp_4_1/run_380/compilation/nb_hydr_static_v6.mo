...
parameter Real chr_flow_nom=612.5178896075205 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=101660.40975995216 "Nominal Dp of each chiller (Pa)";
