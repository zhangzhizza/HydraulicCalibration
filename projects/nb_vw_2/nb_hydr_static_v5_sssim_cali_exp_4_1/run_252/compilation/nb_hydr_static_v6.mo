...
parameter Real chr_flow_nom=589.8870948843106 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=190549.52424887268 "Nominal Dp of each chiller (Pa)";
