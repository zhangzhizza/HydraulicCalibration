...
parameter Real chr_flow_nom=359.1854911724172 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=60592.95910108774 "Nominal Dp of each chiller (Pa)";
