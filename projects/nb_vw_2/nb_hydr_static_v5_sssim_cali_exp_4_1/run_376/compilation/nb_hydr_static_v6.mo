...
parameter Real chr_flow_nom=533.2435499383971 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=134905.5686891963 "Nominal Dp of each chiller (Pa)";
