...
parameter Real chr_flow_nom=474.8925365181074 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=262070.49219735715 "Nominal Dp of each chiller (Pa)";
