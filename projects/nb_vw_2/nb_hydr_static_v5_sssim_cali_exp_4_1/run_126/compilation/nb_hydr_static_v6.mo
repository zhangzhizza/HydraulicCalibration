...
parameter Real chr_flow_nom=968.6121518455765 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=74401.94129020837 "Nominal Dp of each chiller (Pa)";
