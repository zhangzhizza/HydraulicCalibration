...
parameter Real chr_flow_nom=410.17003379155227 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=213462.9958921762 "Nominal Dp of each chiller (Pa)";
