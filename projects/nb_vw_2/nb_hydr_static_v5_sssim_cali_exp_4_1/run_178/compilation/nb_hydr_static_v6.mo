...
parameter Real chr_flow_nom=522.6150342195431 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=75236.56716996909 "Nominal Dp of each chiller (Pa)";
