...
parameter Real chr_flow_nom=978.3372202409209 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=233658.71399081367 "Nominal Dp of each chiller (Pa)";
