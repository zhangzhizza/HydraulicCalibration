...
parameter Real chr_flow_nom=747.8999978688545 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=23800.254051276894 "Nominal Dp of each chiller (Pa)";
