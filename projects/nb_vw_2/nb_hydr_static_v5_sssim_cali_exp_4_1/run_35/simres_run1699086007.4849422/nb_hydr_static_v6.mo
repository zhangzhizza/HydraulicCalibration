...
parameter Real chr_flow_nom=625.9095382536383 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=56736.38106275447 "Nominal Dp of each chiller (Pa)";
