...
parameter Real chr_flow_nom=720.4408800154223 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=133837.48785422958 "Nominal Dp of each chiller (Pa)";
