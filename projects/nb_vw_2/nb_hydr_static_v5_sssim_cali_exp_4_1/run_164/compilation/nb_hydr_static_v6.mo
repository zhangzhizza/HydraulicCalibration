...
parameter Real chr_flow_nom=574.0352665476223 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=261050.53549443456 "Nominal Dp of each chiller (Pa)";
