...
parameter Real chr_flow_nom=459.94183419930795 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=225330.81303402816 "Nominal Dp of each chiller (Pa)";
