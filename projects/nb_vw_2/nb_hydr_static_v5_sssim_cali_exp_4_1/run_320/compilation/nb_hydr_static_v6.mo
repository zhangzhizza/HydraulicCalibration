...
parameter Real chr_flow_nom=458.35091039769475 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=12058.738801514257 "Nominal Dp of each chiller (Pa)";
