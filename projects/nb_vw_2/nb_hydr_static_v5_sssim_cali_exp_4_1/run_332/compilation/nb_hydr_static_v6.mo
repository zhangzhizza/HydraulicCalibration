...
parameter Real chr_flow_nom=545.8483693885125 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=179141.6929126979 "Nominal Dp of each chiller (Pa)";
