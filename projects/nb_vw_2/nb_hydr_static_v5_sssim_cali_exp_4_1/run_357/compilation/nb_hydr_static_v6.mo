...
parameter Real chr_flow_nom=270.43749331941194 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=53820.164621893804 "Nominal Dp of each chiller (Pa)";
