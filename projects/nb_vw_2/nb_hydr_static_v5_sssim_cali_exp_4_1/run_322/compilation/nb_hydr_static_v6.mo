...
parameter Real chr_flow_nom=829.9895671704813 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=275614.3097739339 "Nominal Dp of each chiller (Pa)";
