...
parameter Real chr_flow_nom=144.67955691958667 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=246778.85051901653 "Nominal Dp of each chiller (Pa)";
