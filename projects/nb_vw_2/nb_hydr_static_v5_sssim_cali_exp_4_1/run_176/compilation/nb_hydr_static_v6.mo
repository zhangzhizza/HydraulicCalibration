...
parameter Real chr_flow_nom=763.2595309760412 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=212294.3962280189 "Nominal Dp of each chiller (Pa)";
