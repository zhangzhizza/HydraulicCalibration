...
parameter Real chr_flow_nom=572.7839280512842 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=127355.21480963692 "Nominal Dp of each chiller (Pa)";
