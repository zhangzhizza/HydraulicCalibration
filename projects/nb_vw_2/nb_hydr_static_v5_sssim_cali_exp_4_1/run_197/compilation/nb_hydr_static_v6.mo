...
parameter Real chr_flow_nom=249.22314985301327 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=28266.123060165348 "Nominal Dp of each chiller (Pa)";
