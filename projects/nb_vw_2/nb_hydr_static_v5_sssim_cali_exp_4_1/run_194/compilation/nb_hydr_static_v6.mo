...
parameter Real chr_flow_nom=639.4179896627214 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=129721.09890598842 "Nominal Dp of each chiller (Pa)";
