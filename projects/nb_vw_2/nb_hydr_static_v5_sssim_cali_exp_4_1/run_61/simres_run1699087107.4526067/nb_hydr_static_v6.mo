...
parameter Real chr_flow_nom=156.44507043408066 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=278798.27333730797 "Nominal Dp of each chiller (Pa)";
