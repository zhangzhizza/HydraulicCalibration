...
parameter Real chr_flow_nom=690.7384584029242 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=177662.71869758607 "Nominal Dp of each chiller (Pa)";
