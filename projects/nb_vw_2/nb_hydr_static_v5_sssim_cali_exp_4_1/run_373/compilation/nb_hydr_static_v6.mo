...
parameter Real chr_flow_nom=235.89019558717192 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=268812.36589448166 "Nominal Dp of each chiller (Pa)";
