...
parameter Real chr_flow_nom=850.7229118593249 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=85464.56631059425 "Nominal Dp of each chiller (Pa)";
