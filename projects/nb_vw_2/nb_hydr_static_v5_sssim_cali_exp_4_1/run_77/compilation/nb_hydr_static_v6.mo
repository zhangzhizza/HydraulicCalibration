...
parameter Real chr_flow_nom=903.2163331387267 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=62279.82495070632 "Nominal Dp of each chiller (Pa)";
