...
parameter Real chr_flow_nom=751.4491446980433 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=250854.36446028322 "Nominal Dp of each chiller (Pa)";
