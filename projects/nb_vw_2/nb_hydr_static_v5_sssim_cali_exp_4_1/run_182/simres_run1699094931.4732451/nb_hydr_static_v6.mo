...
parameter Real chr_flow_nom=233.8272275055899 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=109463.77368410064 "Nominal Dp of each chiller (Pa)";
