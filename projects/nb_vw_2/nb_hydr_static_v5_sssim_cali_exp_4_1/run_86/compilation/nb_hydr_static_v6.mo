...
parameter Real chr_flow_nom=769.0922224586121 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=169282.2977853807 "Nominal Dp of each chiller (Pa)";
