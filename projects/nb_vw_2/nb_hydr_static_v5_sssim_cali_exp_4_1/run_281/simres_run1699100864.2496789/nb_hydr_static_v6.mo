...
parameter Real chr_flow_nom=150.91244136950175 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=299517.57289931766 "Nominal Dp of each chiller (Pa)";
