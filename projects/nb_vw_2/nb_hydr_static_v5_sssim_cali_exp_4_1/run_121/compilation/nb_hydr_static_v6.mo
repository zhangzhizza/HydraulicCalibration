...
parameter Real chr_flow_nom=758.4247083120435 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=14365.767010282849 "Nominal Dp of each chiller (Pa)";
