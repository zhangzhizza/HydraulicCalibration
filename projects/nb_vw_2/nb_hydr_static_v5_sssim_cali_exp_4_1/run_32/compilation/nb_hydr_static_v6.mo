...
parameter Real chr_flow_nom=790.6877419303237 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=243918.06085483206 "Nominal Dp of each chiller (Pa)";
