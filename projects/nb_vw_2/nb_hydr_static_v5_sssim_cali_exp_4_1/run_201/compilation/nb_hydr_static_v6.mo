...
parameter Real chr_flow_nom=661.0926589994235 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=286077.83032138005 "Nominal Dp of each chiller (Pa)";
