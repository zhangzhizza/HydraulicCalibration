...
parameter Real chr_flow_nom=585.0749675171999 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=269926.7887127727 "Nominal Dp of each chiller (Pa)";
