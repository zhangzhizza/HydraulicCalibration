...
parameter Real chr_flow_nom=452.73501484678457 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=194957.06468150305 "Nominal Dp of each chiller (Pa)";
