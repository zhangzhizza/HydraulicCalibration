...
parameter Real chr_flow_nom=567.5315842508962 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=21672.584889100173 "Nominal Dp of each chiller (Pa)";
