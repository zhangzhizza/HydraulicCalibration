...
parameter Real chr_flow_nom=162.96909796051386 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=94097.70496630923 "Nominal Dp of each chiller (Pa)";
