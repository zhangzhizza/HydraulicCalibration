...
parameter Real chr_flow_nom=964.6760279275974 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=63542.213066845114 "Nominal Dp of each chiller (Pa)";
