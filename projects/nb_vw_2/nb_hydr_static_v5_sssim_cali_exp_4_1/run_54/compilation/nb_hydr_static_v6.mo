...
parameter Real chr_flow_nom=459.1511688485237 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=148647.25334005844 "Nominal Dp of each chiller (Pa)";
