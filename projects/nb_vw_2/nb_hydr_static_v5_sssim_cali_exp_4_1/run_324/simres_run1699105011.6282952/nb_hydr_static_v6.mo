...
parameter Real chr_flow_nom=227.81650790928995 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=165570.67657976784 "Nominal Dp of each chiller (Pa)";
