...
parameter Real chr_flow_nom=487.97556001220556 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=249200.44403813814 "Nominal Dp of each chiller (Pa)";
