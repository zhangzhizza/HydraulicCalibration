...
parameter Real chr_flow_nom=288.4000509191598 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=239524.0543002826 "Nominal Dp of each chiller (Pa)";
