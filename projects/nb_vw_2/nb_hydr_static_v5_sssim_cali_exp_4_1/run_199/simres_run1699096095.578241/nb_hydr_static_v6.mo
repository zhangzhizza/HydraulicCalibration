...
parameter Real chr_flow_nom=195.5374571806874 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=87621.48560940383 "Nominal Dp of each chiller (Pa)";
