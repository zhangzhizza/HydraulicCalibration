...
parameter Real chr_flow_nom=294.18446859469077 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=142018.79576947936 "Nominal Dp of each chiller (Pa)";
