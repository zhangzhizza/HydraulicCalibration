...
parameter Real chr_flow_nom=644.7667389988275 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=296568.77342993056 "Nominal Dp of each chiller (Pa)";
