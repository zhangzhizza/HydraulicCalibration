...
parameter Real chr_flow_nom=881.9425891030381 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=184896.6778192833 "Nominal Dp of each chiller (Pa)";
