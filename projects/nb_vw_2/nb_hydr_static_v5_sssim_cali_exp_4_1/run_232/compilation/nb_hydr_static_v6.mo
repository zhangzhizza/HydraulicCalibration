...
parameter Real chr_flow_nom=189.81184358090667 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=125619.65684380222 "Nominal Dp of each chiller (Pa)";
