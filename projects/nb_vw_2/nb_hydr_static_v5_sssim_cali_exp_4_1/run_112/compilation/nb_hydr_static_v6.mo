...
parameter Real chr_flow_nom=107.90549520698545 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=252925.61677147885 "Nominal Dp of each chiller (Pa)";
