...
parameter Real chr_flow_nom=576.5125601604141 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=87451.59649167351 "Nominal Dp of each chiller (Pa)";
