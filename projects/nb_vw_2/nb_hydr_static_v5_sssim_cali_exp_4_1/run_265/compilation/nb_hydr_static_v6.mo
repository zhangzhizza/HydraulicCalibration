...
parameter Real chr_flow_nom=755.9109958224748 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=233509.13144438216 "Nominal Dp of each chiller (Pa)";
