...
parameter Real chr_flow_nom=285.3479808419184 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=21262.605662017522 "Nominal Dp of each chiller (Pa)";
