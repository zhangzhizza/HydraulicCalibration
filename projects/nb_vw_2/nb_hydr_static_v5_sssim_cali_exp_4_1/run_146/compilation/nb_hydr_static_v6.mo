...
parameter Real chr_flow_nom=661.6126965417152 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=65228.55871879825 "Nominal Dp of each chiller (Pa)";
