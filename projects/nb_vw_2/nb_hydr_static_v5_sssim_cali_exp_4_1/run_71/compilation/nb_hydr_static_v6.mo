model nb_hydr_static_v6
  ...
  Buildings.Fluid.FixedResistances.Junction jun_4(redeclare package Medium = Buildings.Media.Water, m_flow_nominal = {100, -100, 100}, dp_nominal = {10, 0, 10}) annotation(
    Placement(transformation(extent = {{14, 14}, {-14, -14}}, rotation = -90, origin = {-260, 60})));
  Buildings.Fluid.FixedResistances.Junction jun_5(redeclare package Medium = Buildings.Media.Water, m_flow_nominal = {100, -100, 100}, dp_nominal = {10, 0, 10}) annotation(
    Placement(transformation(extent = {{14, 14}, {-14, -14}}, rotation = -90, origin = {-260, -20})));
  Buildings.Fluid.FixedResistances.Junction jun_6(redeclare package Medium = Buildings.Media.Water, m_flow_nominal = {100, -100, 100}, dp_nominal = {10, 0, 10}) annotation(
...
parameter Real chiller_pipe_len=129.91822818960443 "m";
parameter Real chiller_v_nominal=1.4161120776949305 "m/s";
