...
parameter Real chr_flow_nom=553.5547406193708 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=125795.21913051946 "Nominal Dp of each chiller (Pa)";
