...
parameter Real chr_flow_nom=500.5830846610507 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=234561.7408001635 "Nominal Dp of each chiller (Pa)";
