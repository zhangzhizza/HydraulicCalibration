...
parameter Real chr_flow_nom=380.4307860252991 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=198329.10727516346 "Nominal Dp of each chiller (Pa)";
