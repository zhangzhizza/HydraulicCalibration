...
parameter Real chr_flow_nom=359.552791777542 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=220437.23517327823 "Nominal Dp of each chiller (Pa)";
