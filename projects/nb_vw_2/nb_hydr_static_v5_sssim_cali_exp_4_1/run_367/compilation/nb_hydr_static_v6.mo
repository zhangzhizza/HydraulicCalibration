...
parameter Real chr_flow_nom=944.4652288475718 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=174168.93674988506 "Nominal Dp of each chiller (Pa)";
