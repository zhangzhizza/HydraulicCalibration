...
parameter Real chr_flow_nom=259.9016458746833 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=13547.971195022172 "Nominal Dp of each chiller (Pa)";
