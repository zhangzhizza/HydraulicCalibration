...
parameter Real chr_flow_nom=661.0980055594666 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=164726.6492809143 "Nominal Dp of each chiller (Pa)";
