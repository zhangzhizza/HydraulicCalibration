...
parameter Real chr_flow_nom=558.1242750431713 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=195906.39745557017 "Nominal Dp of each chiller (Pa)";
