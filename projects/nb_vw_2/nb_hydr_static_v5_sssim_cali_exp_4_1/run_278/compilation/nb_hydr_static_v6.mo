...
parameter Real chr_flow_nom=760.6871498016736 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=115863.52526564499 "Nominal Dp of each chiller (Pa)";
