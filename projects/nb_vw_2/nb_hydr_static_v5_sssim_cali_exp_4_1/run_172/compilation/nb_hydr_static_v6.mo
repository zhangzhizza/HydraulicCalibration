...
parameter Real chr_flow_nom=338.03173382696434 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=126724.92622075402 "Nominal Dp of each chiller (Pa)";
