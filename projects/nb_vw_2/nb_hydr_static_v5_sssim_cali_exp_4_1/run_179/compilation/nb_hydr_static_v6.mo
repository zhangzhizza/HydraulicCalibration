...
parameter Real chr_flow_nom=321.14663227995504 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=163114.96064666624 "Nominal Dp of each chiller (Pa)";
