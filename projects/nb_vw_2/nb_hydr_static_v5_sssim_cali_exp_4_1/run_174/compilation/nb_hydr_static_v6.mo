...
parameter Real chr_flow_nom=904.0057684259634 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=138383.9304867491 "Nominal Dp of each chiller (Pa)";
