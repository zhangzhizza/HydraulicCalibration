...
parameter Real chr_flow_nom=103.56846438312985 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=61426.96462191964 "Nominal Dp of each chiller (Pa)";
