...
parameter Real chr_flow_nom=509.85023835228264 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=39913.95676949884 "Nominal Dp of each chiller (Pa)";
