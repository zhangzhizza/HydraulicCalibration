...
parameter Real chr_flow_nom=908.9128765160781 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=129447.22954818688 "Nominal Dp of each chiller (Pa)";
