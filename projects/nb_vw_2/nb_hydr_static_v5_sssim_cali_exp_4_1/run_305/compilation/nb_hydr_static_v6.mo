...
parameter Real chr_flow_nom=478.5992571733284 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=26844.777842791227 "Nominal Dp of each chiller (Pa)";
