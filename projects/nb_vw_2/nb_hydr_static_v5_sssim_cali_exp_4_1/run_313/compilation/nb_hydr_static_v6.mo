...
parameter Real chr_flow_nom=610.8839252031088 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=203910.08491105016 "Nominal Dp of each chiller (Pa)";
