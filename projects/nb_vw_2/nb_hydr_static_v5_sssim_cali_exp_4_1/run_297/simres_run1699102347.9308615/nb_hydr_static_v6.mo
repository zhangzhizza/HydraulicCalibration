...
parameter Real chr_flow_nom=418.58744438517664 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=275527.11283392675 "Nominal Dp of each chiller (Pa)";
