...
parameter Real chr_flow_nom=612.6150600614897 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=251248.9320619679 "Nominal Dp of each chiller (Pa)";
