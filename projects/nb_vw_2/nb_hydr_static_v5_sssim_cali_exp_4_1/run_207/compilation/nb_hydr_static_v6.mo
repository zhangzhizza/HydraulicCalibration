...
parameter Real chr_flow_nom=688.1280889044303 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=203584.13440042068 "Nominal Dp of each chiller (Pa)";
