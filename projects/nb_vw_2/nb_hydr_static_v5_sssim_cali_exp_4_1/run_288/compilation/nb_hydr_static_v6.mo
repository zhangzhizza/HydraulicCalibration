...
parameter Real chr_flow_nom=495.17258431246177 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=224734.02263987713 "Nominal Dp of each chiller (Pa)";
