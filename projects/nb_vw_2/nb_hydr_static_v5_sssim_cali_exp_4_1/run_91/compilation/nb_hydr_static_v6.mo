...
parameter Real chr_flow_nom=129.2922218246705 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=147970.24594267886 "Nominal Dp of each chiller (Pa)";
