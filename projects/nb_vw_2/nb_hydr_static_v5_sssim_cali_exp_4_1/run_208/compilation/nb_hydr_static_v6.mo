...
parameter Real chr_flow_nom=607.2146229402117 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=153924.6906942883 "Nominal Dp of each chiller (Pa)";
