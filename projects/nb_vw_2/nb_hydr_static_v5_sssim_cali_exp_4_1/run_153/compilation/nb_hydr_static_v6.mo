...
parameter Real chr_flow_nom=528.3387978228163 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=223673.0211966077 "Nominal Dp of each chiller (Pa)";
