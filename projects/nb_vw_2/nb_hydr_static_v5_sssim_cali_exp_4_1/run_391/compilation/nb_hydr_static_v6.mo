...
parameter Real chr_flow_nom=964.3318772243991 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=63172.36949467019 "Nominal Dp of each chiller (Pa)";
