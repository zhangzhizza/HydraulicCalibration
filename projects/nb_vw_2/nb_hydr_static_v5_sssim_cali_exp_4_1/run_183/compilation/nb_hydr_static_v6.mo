...
parameter Real chr_flow_nom=689.1445818766197 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=272646.08257072244 "Nominal Dp of each chiller (Pa)";
