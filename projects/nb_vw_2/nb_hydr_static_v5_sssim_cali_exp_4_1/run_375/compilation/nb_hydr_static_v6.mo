...
parameter Real chr_flow_nom=901.3497696610965 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=219500.89141774125 "Nominal Dp of each chiller (Pa)";
