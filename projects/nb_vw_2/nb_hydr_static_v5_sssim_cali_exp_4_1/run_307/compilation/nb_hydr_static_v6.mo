...
parameter Real chr_flow_nom=114.78038449482789 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=89912.22920057028 "Nominal Dp of each chiller (Pa)";
