...
parameter Real chr_flow_nom=740.2000246549459 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=172915.47775975114 "Nominal Dp of each chiller (Pa)";
