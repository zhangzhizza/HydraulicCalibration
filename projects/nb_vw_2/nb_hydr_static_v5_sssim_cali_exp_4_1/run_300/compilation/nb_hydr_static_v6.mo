...
parameter Real chr_flow_nom=935.1712432457497 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=265218.56340427964 "Nominal Dp of each chiller (Pa)";
