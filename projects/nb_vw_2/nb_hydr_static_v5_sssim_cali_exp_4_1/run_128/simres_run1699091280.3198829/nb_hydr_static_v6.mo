...
parameter Real chr_flow_nom=138.8426699556474 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=215079.60945459222 "Nominal Dp of each chiller (Pa)";
