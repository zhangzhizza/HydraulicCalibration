...
parameter Real chr_flow_nom=318.9333449246392 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=69272.76199654804 "Nominal Dp of each chiller (Pa)";
