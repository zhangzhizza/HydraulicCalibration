...
parameter Real chr_flow_nom=874.7180617095282 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=205000.46695304775 "Nominal Dp of each chiller (Pa)";
