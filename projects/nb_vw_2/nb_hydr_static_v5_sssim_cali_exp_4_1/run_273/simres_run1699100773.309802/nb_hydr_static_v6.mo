...
parameter Real chr_flow_nom=158.05372310089177 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=26438.21681349035 "Nominal Dp of each chiller (Pa)";
