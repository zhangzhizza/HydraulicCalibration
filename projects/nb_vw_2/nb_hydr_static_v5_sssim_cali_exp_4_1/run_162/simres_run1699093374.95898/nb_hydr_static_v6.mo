...
parameter Real chr_flow_nom=175.09939467599227 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=282940.4806614851 "Nominal Dp of each chiller (Pa)";
