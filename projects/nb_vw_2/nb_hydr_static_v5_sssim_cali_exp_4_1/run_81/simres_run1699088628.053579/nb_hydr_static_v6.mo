...
parameter Real chr_flow_nom=186.63987027356475 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=73007.27896232324 "Nominal Dp of each chiller (Pa)";
