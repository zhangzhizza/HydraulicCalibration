...
parameter Real chr_flow_nom=838.5593634764762 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=268225.92430381576 "Nominal Dp of each chiller (Pa)";
