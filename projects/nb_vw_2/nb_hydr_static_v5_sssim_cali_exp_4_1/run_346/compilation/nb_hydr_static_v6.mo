...
parameter Real chr_flow_nom=306.0323425844616 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=223978.6621244592 "Nominal Dp of each chiller (Pa)";
