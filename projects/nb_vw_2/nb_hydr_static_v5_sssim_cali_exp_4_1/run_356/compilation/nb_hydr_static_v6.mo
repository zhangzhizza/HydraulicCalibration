...
parameter Real chr_flow_nom=591.5913875572759 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=259686.27122927015 "Nominal Dp of each chiller (Pa)";
