...
parameter Real chr_flow_nom=565.4395641365221 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=289682.5764265166 "Nominal Dp of each chiller (Pa)";
