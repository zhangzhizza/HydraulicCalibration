...
parameter Real chr_flow_nom=672.7299076176134 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=250641.5626211307 "Nominal Dp of each chiller (Pa)";
