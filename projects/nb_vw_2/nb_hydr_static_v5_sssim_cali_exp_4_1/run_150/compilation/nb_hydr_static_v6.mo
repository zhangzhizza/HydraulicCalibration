...
parameter Real chr_flow_nom=140.55604865707448 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=68039.44686727817 "Nominal Dp of each chiller (Pa)";
