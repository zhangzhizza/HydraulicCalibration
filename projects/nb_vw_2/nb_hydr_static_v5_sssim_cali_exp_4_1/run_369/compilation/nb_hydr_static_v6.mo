...
parameter Real chr_flow_nom=416.03111313152687 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=200837.89587956484 "Nominal Dp of each chiller (Pa)";
