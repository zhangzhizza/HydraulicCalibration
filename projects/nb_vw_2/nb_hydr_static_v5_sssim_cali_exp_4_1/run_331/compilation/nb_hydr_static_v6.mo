...
parameter Real chr_flow_nom=949.8660232972046 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=58614.70727893826 "Nominal Dp of each chiller (Pa)";
