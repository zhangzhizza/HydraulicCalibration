...
parameter Real chr_flow_nom=644.0486366655261 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=263831.3089711929 "Nominal Dp of each chiller (Pa)";
