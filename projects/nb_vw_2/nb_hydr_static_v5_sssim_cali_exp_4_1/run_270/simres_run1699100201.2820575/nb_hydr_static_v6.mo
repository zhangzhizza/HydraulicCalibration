...
parameter Real chr_flow_nom=246.68434766972283 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=160196.32975701944 "Nominal Dp of each chiller (Pa)";
