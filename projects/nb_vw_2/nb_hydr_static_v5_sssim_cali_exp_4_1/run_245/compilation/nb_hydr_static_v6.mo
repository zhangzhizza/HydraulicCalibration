...
parameter Real chr_flow_nom=907.6650450022419 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=114373.0576491959 "Nominal Dp of each chiller (Pa)";
