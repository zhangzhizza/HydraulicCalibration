...
parameter Real chr_flow_nom=996.5733555234958 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=97956.07496536858 "Nominal Dp of each chiller (Pa)";
