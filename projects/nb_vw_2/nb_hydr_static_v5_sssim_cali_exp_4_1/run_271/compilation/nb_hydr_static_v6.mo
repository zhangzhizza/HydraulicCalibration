...
parameter Real chr_flow_nom=668.354581202254 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=200532.83521358224 "Nominal Dp of each chiller (Pa)";
