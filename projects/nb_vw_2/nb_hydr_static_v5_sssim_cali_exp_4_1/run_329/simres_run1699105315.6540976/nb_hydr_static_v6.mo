...
parameter Real chr_flow_nom=926.2754927381899 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=14363.18487791747 "Nominal Dp of each chiller (Pa)";
