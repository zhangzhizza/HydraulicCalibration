...
parameter Real chr_flow_nom=751.2088228377394 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=10776.371402970075 "Nominal Dp of each chiller (Pa)";
