...
parameter Real chr_flow_nom=841.9185965657238 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=124869.68238676994 "Nominal Dp of each chiller (Pa)";
