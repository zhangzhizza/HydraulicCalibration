...
parameter Real chr_flow_nom=528.5162083622342 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=277298.6373439754 "Nominal Dp of each chiller (Pa)";
