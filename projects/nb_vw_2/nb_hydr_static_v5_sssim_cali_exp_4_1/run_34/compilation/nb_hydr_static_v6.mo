...
parameter Real chr_flow_nom=571.2559416459314 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=170764.60129352612 "Nominal Dp of each chiller (Pa)";
