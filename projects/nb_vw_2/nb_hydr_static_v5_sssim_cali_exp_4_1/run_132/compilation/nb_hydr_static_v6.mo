...
parameter Real chr_flow_nom=568.4665273542437 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=125069.42299543555 "Nominal Dp of each chiller (Pa)";
