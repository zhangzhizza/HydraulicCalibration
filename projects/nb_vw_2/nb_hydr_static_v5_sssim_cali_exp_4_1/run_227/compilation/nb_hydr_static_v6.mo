...
parameter Real chr_flow_nom=800.6569156078237 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=18214.64536938155 "Nominal Dp of each chiller (Pa)";
