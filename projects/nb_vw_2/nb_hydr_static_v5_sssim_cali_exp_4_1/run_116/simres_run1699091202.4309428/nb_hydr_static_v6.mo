...
parameter Real chr_flow_nom=788.0763301759504 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=150599.2530812682 "Nominal Dp of each chiller (Pa)";
