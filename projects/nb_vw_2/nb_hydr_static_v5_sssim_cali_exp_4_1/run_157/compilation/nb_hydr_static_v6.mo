...
parameter Real chr_flow_nom=341.2573778879824 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=291528.52114160935 "Nominal Dp of each chiller (Pa)";
