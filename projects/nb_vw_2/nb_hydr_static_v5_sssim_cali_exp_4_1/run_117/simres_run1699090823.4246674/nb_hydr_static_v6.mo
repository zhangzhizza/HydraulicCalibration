...
parameter Real chr_flow_nom=169.1609324480582 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=75996.55167162302 "Nominal Dp of each chiller (Pa)";
