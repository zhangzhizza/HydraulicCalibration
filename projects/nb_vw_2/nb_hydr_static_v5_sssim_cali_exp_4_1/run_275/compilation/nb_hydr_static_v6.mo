...
parameter Real chr_flow_nom=782.4995033112742 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=162272.33249099058 "Nominal Dp of each chiller (Pa)";
