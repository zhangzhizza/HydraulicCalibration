...
parameter Real chr_flow_nom=172.53346541777827 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=134216.7748280347 "Nominal Dp of each chiller (Pa)";
