...
parameter Real chr_flow_nom=180.33596655719998 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=37360.27465034339 "Nominal Dp of each chiller (Pa)";
