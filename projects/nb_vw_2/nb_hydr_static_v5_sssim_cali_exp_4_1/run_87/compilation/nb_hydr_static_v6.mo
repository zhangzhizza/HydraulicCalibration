...
parameter Real chr_flow_nom=754.7024008386012 "Nominal flow rate of each chiller (kg/s)";
parameter Real chr_dp_nom=252614.11775341406 "Nominal Dp of each chiller (Pa)";
