...
protected
  ...
  Buildings.ThermalZones.Detailed.BaseClasses.HeatGain heaGai(
    ...
    annotation (Placement(transformation(extent={{-180,90},{-152,110}})));
...
equation
  connect(heaGai.qGai_flow,qGai_flow)
    annotation (Line(points={{-182.8,100},{-220,100}},
                                                    color={0,0,127}));
  ...
  connect(heaGai.QRad_flow,fmuZon.QGaiRad_flow)
    annotation (Line(points={{-149.2,106},{74,106},{74,-58},{80,-58}},
                                                                    color={0,0,127}));
  ...
  connect(QConTot_flow.u2,heaGai.QCon_flow)
    annotation (Line(points={{-122,56},{-134,56},{-134,100},{-149.2,100}},
                                                                        color={0,0,127}));
  ...
  connect(heaGai.QLat_flow,QConLat_flow.u2)
    annotation (Line(points={{-149.2,94},{-144,94},{-144,24},{-122,24}},
                                                                      color={0,0,127}));
  annotation (
