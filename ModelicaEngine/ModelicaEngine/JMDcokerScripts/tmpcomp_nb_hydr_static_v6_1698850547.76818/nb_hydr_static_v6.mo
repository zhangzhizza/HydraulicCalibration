...
parameter Real chiller_pipe_len=154.73220351619875 "m";
parameter Real chiller_v_nominal=3.609965308245734 "m/s";
  ...
  Modelica.Blocks.Sources.Constant pump_speed_3(k = 0.610) "Pump speed constant" annotation(
    Placement(transformation(extent = {{-340, -318}, {-320, -298}})));
  Modelica.Blocks.Sources.Constant pump_speed_4(k = 0) "Pump speed constant" annotation(
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear terminal_resist(CvData = Buildings.Fluid.Types.CvTypes.OpPoint, redeclare package Medium = Buildings.Media.Water, dpFixed_nominal = 0, dpValve_nominal = 100000, m_flow_nominal = 1500) annotation(
