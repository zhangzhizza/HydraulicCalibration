...
model nb_hydr_static
  ...
  Buildings.Fluid.Sensors.MassFlowRate chw_ret_m(redeclare package Medium =
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={58,84})));
  Modelica.Blocks.Sources.Constant pump_speed_const(k=1) "Pump speed constant"
    annotation (Placement(transformation(extent={{-296,-292},{-276,-272}})));
  ...
  Buildings.Fluid.FixedResistances.PressureDrop terminal_resist(
    redeclare package Medium = Buildings.Media.Water,
    m_flow_nominal=500,
    dp_nominal=100000) "Resistance of terminals"
    annotation (Placement(transformation(extent={{32,122},{70,154}})));
...
equation
  ...
  connect(pump_speed_const.y, chwp_4.y) annotation (Line(points={{-275,-282},{
          -80,-282},{-80,-199.2}}, color={0,0,127}));
  connect(pump_speed_const.y, chwp_3.y) annotation (Line(points={{-275,-282},{
          -80,-282},{-80,-208},{-104,-208},{-104,-132},{-80,-132},{-80,-119.2}},
        color={0,0,127}));
  connect(pump_speed_const.y, chwp_2.y) annotation (Line(points={{-275,-282},{
          -80,-282},{-80,-208},{-104,-208},{-104,-52},{-80,-52},{-80,-39.2}},
        color={0,0,127}));
  connect(pump_speed_const.y, chwp_1.y) annotation (Line(points={{-275,-282},{
          -80,-282},{-80,-208},{-104,-208},{-104,28},{-80,28},{-80,40.8}},
        color={0,0,127}));
  ...
  connect(terminal_resist.port_b, chw_sup.ports[1]) annotation (Line(points={{
          70,138},{132,138},{132,154},{146,154}}, color={0,127,255}));
  connect(chw_sup_P.port, terminal_resist.port_a) annotation (Line(points={{-12,
          152},{-12,138},{32,138}}, color={0,127,255}));
  connect(chw_term_P.port, chw_sup.ports[2]) annotation (Line(points={{92,152},
          {92,138},{132,138},{132,160},{146,160}}, color={0,127,255}));
  annotation (
